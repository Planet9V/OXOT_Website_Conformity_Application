...
## Phase 18 — RED→CRA handover as per-product guidance (opened + closed 2026-08-17)
...
- **18.1 done** The fact: nullable `redInScope` boolean on
...
- **18.2 done** The panel: `red-handover-panel.tsx` in the product file,
...
## Phase 22 — Door file upload + public wiki lead magnets (opened + closed 2026-08-17)
...
- **22.1 done** Supplier-door FILE upload, hardened at birth even though the
...
- **22.2 done** Public statutory wikis on the marketing site: corpus bundles
...
- **22.3 done** Gates, G6, commit/push, CI, G7.
