...
> **Canonical Code:** `TC_06` (Investigative Episode 06)  
...
### 1.1 Episode Title
`[CRA: Truth & Consequences Ep. 06] The Decommissioning & End-of-Life Handover: Legal Liabilities When Retiring Critical OT | Jim Mckenney`
...
08:45 - The Unvarnished Statutory Reality (Article 13(9), Annex VII, Recital 32)
...
Today's case: The Decommissioning & End-of-Life Handover: Legal Liabilities When Retiring Critical OT.
...
Let's look at the statutory facts under Article 13(9), Annex VII, Recital 32:
Retiring a product line does not extinguish the 10-year technical file retention rule, nor does it excuse failure to sanitize cryptographic credentials before equipment enters the secondary resale market.

Here is the inconvenient truth that nobody wants to admit:
You cannot shred your compliance files when you shut down a line. End-of-life requires cryptographic key zeroization certificates and immutable 10-year digital archiving.
...
Output: `docs/cra_podcast/truth_and_consequences/audio/TC_06.mp3`
