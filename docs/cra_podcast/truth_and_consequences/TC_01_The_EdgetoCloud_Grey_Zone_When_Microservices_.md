...
> **Canonical Code:** `TC_01` (Investigative Episode 01)  
...
### 1.1 Episode Title
`[CRA: Truth & Consequences Ep. 01] The Edge-to-Cloud Grey Zone: When Microservices Void Local Controller CE Marks | Jim Mckenney`
...
08:45 - The Unvarnished Statutory Reality (Article 3(2), Article 21, Annex I Part I §1)
...
Today's case: The Edge-to-Cloud Grey Zone: When Microservices Void Local Controller CE Marks.
...
Let's look at the statutory facts under Article 3(2), Article 21, Annex I Part I §1:
Under Article 3(2) and Article 21, software updates that alter cybersecurity properties or intended use constitute Substantial Modifications. If an edge container changes how a physical skid responds to commands, the CE mark on that cabinet is legally dead.

Here is the inconvenient truth that nobody wants to admit:
There are no agile shortcuts. If you push containers to edge OT, you must maintain deterministic container signing, Purdue Level 2 isolation, and an immutable Annex VII technical dossier.
...
Output: `docs/cra_podcast/truth_and_consequences/audio/TC_01.mp3`
