# [EP_6.02 - SOLO] Building an Annex I Compliant PSIRT: Roles, Playbooks & Tooling for Hardware OEMs
...
> - **Canonical Code:** `EP_6.02` (Global Episode 35)
> - **Statutory References:** Annex I Part II, Article 13(6)
> - **Target Audio Duration:** 12–15 Minutes
> - **Target Persona:** Product Security Directors & DevSecOps
...
`[EP_6.02 - Solo Briefing] Building an Annex I Compliant PSIRT: Roles, Playbooks & Tooling for Hardware OEMs | Jim Mckenney`

### 1.2 Spotify Timestamped Chapter Markers
```text
00:00 - Introduction: Building an Annex I Compliant PSIRT: Roles, Playbooks & Tooling for Hardware OEMs
01:30 - Statutory Architecture & Legal Breakdown (Annex I Part II, Article 13(6))
05:15 - Operational Impact & Industry Analysis (Product Security Directors & DevSecOps)
...
- **Primary Audience:** `Product Security Directors & DevSecOps`
- **Executive Value Proposition:** Translates statutory requirements under Annex I Part II, Article 13(6) into defensible engineering architectures and contract safe-harbor clauses, eliminating Article 61 fine exposure.
...
Today, we're cutting straight through the theoretical legal noise to address an essential dimension of European product security and industrial resilience: Building an Annex I Compliant PSIRT: Roles, Playbooks & Tooling for Hardware OEMs.

Let's ground our discussion in the exact statutory text of Annex I Part II, Article 13(6).

When we examine the operational, commercial, and engineering reality of Product Security Directors & DevSecOps, the central challenge under Annex I Part II, Article 13(6) is clear: how to translate rigorous statutory requirements into defensible engineering architectures and robust supply-chain agreements.

Under European Union product harmonisation legislation, the obligations set forth in Annex I Part II, Article 13(6) attach directly to economic operators the moment a product with digital elements is placed on the market or substantially modified.
...
If an organization fails to align its design practices, technical documentation, software supply-chain tracking, and incident response playbooks with Annex I Part II, Article 13(6), it faces immediate market access restrictions, mandatory product recalls, and severe administrative penalties under Article 61 reaching up to 15 million euros or 2.5 percent of global turnover.
...
Step One: Audit your active product portfolios and contractual scopes governed by Annex I Part II, Article 13(6).
