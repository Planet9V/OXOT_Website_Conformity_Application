# [EP_1.03 - SOLO] Open Source Software & The CRA: What Commercial Stewards Must Know
...
`[EP_1.03 - Solo Briefing] Open Source Software & The CRA: What Commercial Stewards Must Know | Jim Mckenney`

### 1.2 Spotify Chapter Markers
```text
00:00 - Introduction: Jim Mckenney & Industrial Digital Product Security
01:15 - Statutory Fact Sheet: Recital 10, Article 13
06:00 - Industrial OT & OEM Impact: SaaS & Open Source Maintainers
...
[JIM MCKENNEY]
Welcome back. I'm Jim Mckenney, digital product security consultant. I work directly with industrial manufacturers, OEMs, and operators to align OT devices and software with the Cyber Resilience Act, IEC 62443, the EU AI Act, and the Machinery Regulation. Today, we're cutting through the legal noise on Open Source Software & The CRA: What Commercial Stewards Must Know under Regulation [pronunciation: EU twenty-twenty-four slash twenty-eight-forty-seven].

Let's look at the statutory facts in Recital 10, Article 13. Explains Recital 10 open-source exemptions vs commercial open-source stewardship liabilities, foundation obligations, and supply-chain security.
...
First: Review your technical documentation against Recital 10, Article 13.
...
Until next time: keep open source transparent, build commercial trust. I'm Jim Mckenney—thanks for listening.
