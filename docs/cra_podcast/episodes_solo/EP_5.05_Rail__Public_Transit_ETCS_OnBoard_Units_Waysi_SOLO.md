# [EP_5.05 - SOLO] Rail & Public Transit: ETCS On-Board Units, Wayside Signaling & Train Control
...
> - **Canonical Code:** `EP_5.05` (Global Episode 30)
> - **Statutory References:** Annex IV, EN 50126, EN 50128
> - **Target Audio Duration:** 12–15 Minutes
> - **Target Persona:** Rolling Stock OEMs & Railway Engineers
...
`[EP_5.05 - Solo Briefing] Rail & Public Transit: ETCS On-Board Units, Wayside Signaling & Train Control | Jim Mckenney`

### 1.2 Spotify Timestamped Chapter Markers
```text
00:00 - Introduction: Rail & Public Transit: ETCS On-Board Units, Wayside Signaling & Train Control
01:30 - Statutory Architecture & Legal Breakdown (Annex IV, EN 50126, EN 50128)
05:15 - Operational Impact & Industry Analysis (Rolling Stock OEMs & Railway Engineers)
...
Today, we're cutting straight through the theoretical legal noise to address an essential dimension of European product security and industrial resilience: Rail & Public Transit: ETCS On-Board Units, Wayside Signaling & Train Control.

Let's ground our discussion in the exact statutory text of Annex IV, EN 50126, EN 50128.

When we examine the operational, commercial, and engineering reality of Rolling Stock OEMs & Railway Engineers, the central challenge under Annex IV, EN 50126, EN 50128 is clear: how to translate rigorous statutory requirements into defensible engineering architectures and robust supply-chain agreements.

Under European Union product harmonisation legislation, the obligations set forth in Annex IV, EN 50126, EN 50128 attach directly to economic operators the moment a product with digital elements is placed on the market or substantially modified.
...
If an organization fails to align its design practices, technical documentation, software supply-chain tracking, and incident response playbooks with Annex IV, EN 50126, EN 50128, it faces immediate market access restrictions, mandatory product recalls, and severe administrative penalties under Article 61 reaching up to 15 million euros or 2.5 percent of global turnover.
...
Step One: Audit your active product portfolios and contractual scopes governed by Annex IV, EN 50126, EN 50128.
