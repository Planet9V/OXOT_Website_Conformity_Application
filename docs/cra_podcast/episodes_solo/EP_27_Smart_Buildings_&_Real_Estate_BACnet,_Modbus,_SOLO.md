# [CRA Ep. 27 - SOLO] Smart Buildings & Real Estate: BACnet, Modbus, Access Control & Elevators
...
`[CRA Ep. 27 - Solo Briefing] Smart Buildings & Real Estate: BACnet, Modbus, Access Control & Elevators | Jim Mckenney`
...
Today, we're cutting straight through the theoretical legal noise to address an essential dimension of European product security and industrial resilience: Smart Buildings & Real Estate: BACnet, Modbus, Access Control & Elevators.

Let's ground our discussion in the exact statutory text of Article 6, Annex III.

When we examine the operational, commercial, and engineering reality of Smart Building Systems Integrators (MSI), the central challenge under Article 6, Annex III is clear: how to translate rigorous statutory requirements into defensible engineering architectures and robust supply-chain agreements.

Under European Union product harmonisation legislation, the obligations set forth in Article 6, Annex III attach directly to economic operators the moment a product with digital elements is placed on the market or substantially modified.
...
If an organization fails to align its design practices, technical documentation, software supply-chain tracking, and incident response playbooks with Article 6, Annex III, it faces immediate market access restrictions, mandatory product recalls, and severe administrative penalties under Article 61 reaching up to 15 million euros or 2.5 percent of global turnover.
...
Step One: Audit your active product portfolios and contractual scopes governed by Article 6, Annex III.
