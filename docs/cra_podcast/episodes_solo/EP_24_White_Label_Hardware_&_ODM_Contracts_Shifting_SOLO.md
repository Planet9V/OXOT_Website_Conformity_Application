# [CRA Ep. 24 - SOLO] White-Label Hardware & ODM Contracts: Shifting the CE Nameplate Burden
...
`[CRA Ep. 24 - Solo Briefing] White-Label Hardware & ODM Contracts: Shifting the CE Nameplate Burden | Jim Mckenney`
