# [CRA Ep. 38 - SOLO] Customer Security Advisories: Drafting Bulletins Without Exposing Clients to Attack
...
`[CRA Ep. 38 - Solo Briefing] Customer Security Advisories: Drafting Bulletins Without Exposing Clients to Attack | Jim Mckenney`
