# [EP_1.02 - SOLO] Writing the Bulletproof CRA RFP: Specification Language for Asset Owners
...
> - **Canonical Code:** `EP_1.02` (Global Episode 02)
...
`[EP_1.02 - Solo Briefing] Writing the Bulletproof CRA RFP: Specification Language for Asset Owners | Jim Mckenney`
...
01:30 - Statutory Architecture & Requirements (Article 13, Annex I Part I)
...
Today, we're cutting straight through the theoretical legal noise to address an essential dimension of European product security and industrial resilience: Writing the Bulletproof CRA RFP: Specification Language for Asset Owners.

Let's ground our discussion in the exact statutory text of Article 13, Annex I Part I.

When we examine the operational, commercial, and engineering reality of Procurement Directors & CISOs, the central challenge under Article 13, Annex I Part I is clear: how to translate rigorous statutory requirements into defensible engineering architectures and robust supply-chain agreements.

Under European Union product harmonisation legislation, the obligations set forth in Article 13, Annex I Part I attach directly to economic operators the moment a product with digital elements is placed on the market or substantially modified.
...
Step One: Audit your active product portfolios and contractual scopes governed by Article 13, Annex I Part I.
