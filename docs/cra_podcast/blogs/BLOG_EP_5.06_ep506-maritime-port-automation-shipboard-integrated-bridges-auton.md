...
slug: "ep506-maritime-port-automation-shipboard-integrated-bridges-auton"
date: "2026-08-14"
author: "Jim Mckenney"
...
keywords: ["Cyber Resilience Act", "CRA Compliance", "IEC 62443", "Article 2(1)", "OT Cybersecurity", "CE Marking", "Annex VII"]
---
...
> - **Statutory Scope:** `Article 2(1), IACS UR E26/E27` (Regulation (EU) 2024/2847)
> - **Primary Role:** `Port Terminal Operators & Marine Integrators`
> - **Audio Briefing:** [EP_5.06 - Single-Voice Episode](https://oxot.ai/podcast) | [Spotify / Apple RSS](https://oxot.ai/feeds/cra-podcast.xml)
> - **Statutory Reference:** [Inspect Article 2(1) on the Live CRA Wiki](https://oxot.ai/wiki/cra)
...
When engineering teams and plant managers examine their supply chain obligations under **Article 2(1), IACS UR E26/E27**, the central conflict is almost never theoretical—it is operational:
...
## 2. Statutory Breakdown: What Article 2(1), IACS UR E26/E27 Demands
...
```
+----------------------------------------------------------------------------------------------------+
| CORE STATUTORY OBLIGATIONS UNDER ARTICLE 2(1), IACS UR E26/E27                                            |
+---------------------+------------------------------------------------------------------------------+
...
To meet `Article 2(1), IACS UR E26/E27` without causing production line delays or breaking field retrofits, deploy the following four-tier architecture:
...
- **Audio Asset:** [`https://oxot.ai/audio/cra_podcast/EP_5.06.mp3`](https://oxot.ai/audio/cra_podcast/EP_5.06.mp3)
