...
slug: "ep203-custom-scada-scripts-vs-product-logic-where-the-cra-regulat"
date: "2026-08-14"
author: "Jim Mckenney"
...
> - **Statutory Scope:** `Article 2(1), Recital 6` (Regulation (EU) 2024/2847)
> - **Primary Role:** `SCADA Developers & PLC Programmers`
> - **Audio Briefing:** [EP_2.03 - Single-Voice Episode](https://oxot.ai/podcast) | [Spotify / Apple RSS](https://oxot.ai/feeds/cra-podcast.xml)
...
When engineering teams and plant managers examine their supply chain obligations under **Article 2(1), Recital 6**, the central conflict is almost never theoretical—it is operational:
...
## 2. Statutory Breakdown: What Article 2(1), Recital 6 Demands
...
```
+----------------------------------------------------------------------------------------------------+
| CORE STATUTORY OBLIGATIONS UNDER ARTICLE 2(1), RECITAL 6                                            |
+---------------------+------------------------------------------------------------------------------+
...
To meet `Article 2(1), Recital 6` without causing production line delays or breaking field retrofits, deploy the following four-tier architecture:
...
- **Audio Asset:** [`https://oxot.ai/audio/cra_podcast/EP_2.03.mp3`](https://oxot.ai/audio/cra_podcast/EP_2.03.mp3)
