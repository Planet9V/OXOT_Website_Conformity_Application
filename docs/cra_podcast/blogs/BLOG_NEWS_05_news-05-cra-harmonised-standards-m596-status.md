...
## Where M/606 actually stands

The Commission has done what the Regulation requires: it adopted and issued a formal standardisation request to the European standardisation organisations—CEN, CENELEC, and ETSI—to develop harmonised standards for the CRA's essential requirements. The official Commission Implementing Decision carries the mandate reference **M/606** (C(2025) 618 final). It establishes a rigorous program of 41 distinct standardisation deliverables: horizontal cybersecurity standards under CEN/CLC JTC 13 (the emerging **prEN 40000 series**) and specialized vertical/component standards under ETSI TC CYBER (the **EN 304 6xx series**). The work is live and running through the relevant technical committees, adapting established global benchmarks like IEC 62443 and ETSI EN 303 645 into CRA-specific harmonised texts rather than writing from a blank page.
