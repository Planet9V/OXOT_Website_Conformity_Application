...
slug: "ep602-building-an-annex-i-compliant-psirt-roles-playbooks-tooling"
date: "2026-08-14"
author: "Jim Mckenney"
...
> - **Statutory Scope:** `Annex I Part II, Article 13(6)` (Regulation (EU) 2024/2847)
> - **Primary Role:** `Product Security Directors & DevSecOps`
> - **Audio Briefing:** [EP_6.02 - Single-Voice Episode](https://oxot.ai/podcast) | [Spotify / Apple RSS](https://oxot.ai/feeds/cra-podcast.xml)
...
When engineering teams and plant managers examine their supply chain obligations under **Annex I Part II, Article 13(6)**, the central conflict is almost never theoretical—it is operational:
...
## 2. Statutory Breakdown: What Annex I Part II, Article 13(6) Demands
...
```
+----------------------------------------------------------------------------------------------------+
| CORE STATUTORY OBLIGATIONS UNDER ANNEX I PART II, ARTICLE 13(6)                                            |
+---------------------+------------------------------------------------------------------------------+
...
To meet `Annex I Part II, Article 13(6)` without causing production line delays or breaking field retrofits, deploy the following four-tier architecture:
...
- **Audio Asset:** [`https://oxot.ai/audio/cra_podcast/EP_6.02.mp3`](https://oxot.ai/audio/cra_podcast/EP_6.02.mp3)
