...
slug: "ep504-water-wastewater-utilities-scada-remote-telemetry-dosing-co"
date: "2026-08-14"
author: "Jim Mckenney"
...
keywords: ["Cyber Resilience Act", "CRA Compliance", "IEC 62443", "Annex III", "OT Cybersecurity", "CE Marking", "Annex VII"]
---
...
> - **Statutory Scope:** `Annex III, NIS2 Annex I` (Regulation (EU) 2024/2847)
> - **Primary Role:** `Municipal Water Engineers & SCADA Leads`
> - **Audio Briefing:** [EP_5.04 - Single-Voice Episode](https://oxot.ai/podcast) | [Spotify / Apple RSS](https://oxot.ai/feeds/cra-podcast.xml)
> - **Statutory Reference:** [Inspect Annex III on the Live CRA Wiki](https://oxot.ai/wiki/cra)
...
When engineering teams and plant managers examine their supply chain obligations under **Annex III, NIS2 Annex I**, the central conflict is almost never theoretical—it is operational:
...
## 2. Statutory Breakdown: What Annex III, NIS2 Annex I Demands
...
```
+----------------------------------------------------------------------------------------------------+
| CORE STATUTORY OBLIGATIONS UNDER ANNEX III, NIS2 ANNEX I                                            |
+---------------------+------------------------------------------------------------------------------+
...
To meet `Annex III, NIS2 Annex I` without causing production line delays or breaking field retrofits, deploy the following four-tier architecture:
...
- **Audio Asset:** [`https://oxot.ai/audio/cra_podcast/EP_5.04.mp3`](https://oxot.ai/audio/cra_podcast/EP_5.04.mp3)
