...
Joint Technical Committee 13 is currently adapting existing global standards to create formal CRA harmonised standards:

For consumer IoT and connected devices, ETSI EN 303 645 is being mapped directly to Annex I Part I requirements.

For industrial automation and control systems, IEC 62443-4-1 and 4-2 are being harmonized for industrial OT devices.

For software development lifecycles, ISO/IEC 27001 and secure software development frameworks are being aligned.
