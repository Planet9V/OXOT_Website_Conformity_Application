...
export const recitalsData = {
  ...
  "celex": "32024R2847",
  "sourceUrl": "https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=OJ:L_202402847",
  ...
  "recitals": [
    ...
    },
    {
      "number": 8,
      "title": "Recital 8",
      "text": "To increase the overall level of cybersecurity of all products with digital elements placed on the internal market, it is necessary to introduce objective-oriented and technology-neutral essential cybersecurity requirements for those products that apply horizontally.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 14,
      "title": "Recital 14",
      "text": "This Regulation should be without prejudice to the Member States’ responsibility for safeguarding national security, in compliance with Union law. Member States should be able to subject products with digital elements that are procured or used for national security or defence purposes to additional measures, provided that such measures are consistent with Member States’ obligations laid down in Union law.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 16,
      "title": "Recital 16",
      "text": "Products with digital elements provided as part of the delivery of a service for which a fee is charged solely to recover the actual costs directly related to the operation of that service, such as may be the case with certain products with digital elements provided by public administration entities, should not be considered on those grounds alone to be a commercial activity for the purposes of this Regulation. Furthermore, products with digital elements which are developed or modified by a public administration entity exclusively for its own use should not be considered to be made available on the market within the meaning of this Regulation.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 64,
      "title": "Recital 64",
      "text": "Manufacturers should make their products with digital elements available on the market with a secure by default configuration and provide security updates to users free of charge. Manufacturers should only be able to deviate from the essential cybersecurity requirements in relation to tailor-made products that are fitted to a particular purpose for a particular business user and where both the manufacturer and the user have explicitly agreed to a different set of contractual terms.",
      "tags": [
        "Manufacturer"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 65,
      "title": "Recital 65",
      "text": "Manufacturers should notify simultaneously via the single reporting platform both the computer security incident response team (CSIRT) designated as coordinator as well as ENISA of actively exploited vulnerabilities contained in products with digital elements, as well as severe incidents having an impact on the security of those products. The notifications should be submitted using the electronic notification end-point of a CSIRT designated as coordinator and should be simultaneously accessible to ENISA.",
      "tags": [
        "VulnerabilityHandling",
        "Reporting",
        "Manufacturer"
    ...
    },
    {
      "number": 74,
      "title": "Recital 74",
      "text": "Manufacturers and other natural and legal persons should be able to notify to a CSIRT designated as coordinator or ENISA, on a voluntary basis, any vulnerability contained in a product with digital elements, cyber threats that could affect the risk profile of a product with digital elements, any incident having an impact on the security of the product with digital elements as well as near misses that could have resulted in such an incident.",
      "tags": [
        "VulnerabilityHandling",
        "Reporting",
        "Manufacturer"
    ...
    },
    {
      "number": 84,
      "title": "Recital 84",
      "text": "With a view to establishing, in the most efficient way, common specifications that cover the essential cybersecurity requirements set out in this Regulation, the Commission should involve relevant stakeholders in the process.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 86,
      "title": "Recital 86",
      "text": "In order to facilitate the assessment of conformity with the essential cybersecurity requirements set out in this Regulation, there should be a presumption of conformity for products with digital elements that are in conformity with the common specifications adopted by the Commission pursuant to this Regulation for the purpose of expressing detailed technical specifications of those requirements.",
      "tags": [
        "SME"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 88,
      "title": "Recital 88",
      "text": "Manufacturers should draw up an EU declaration of conformity to provide information required under this Regulation on the conformity of products with digital elements with the essential cybersecurity requirements set out in this Regulation and, where applicable, of the other relevant Union harmonisation legislation by which the product with digital elements is covered. Manufacturers may also be required to draw up an EU declaration of conformity by other Union legal acts. To ensure effective access to information for market surveillance purposes, a single EU declaration of conformity should be drawn up in respect of compliance with all relevant Union legal acts. In order to reduce the administrative burden on economic operators, it should be possible for that single EU declaration of conformity to be a dossier made up of relevant individual declarations of conformity.",
      "tags": [
        "MarketSurveillance",
        "Manufacturer"
      ],
    ...
    },
    {
      "number": 89,
      "title": "Recital 89",
      "text": "The CE marking, indicating the conformity of a product, is the visible consequence of a whole process comprising conformity assessment in a broad sense. The general principles governing the CE marking are set out in Regulation (EC) No 765/2008 of the European Parliament and of the Council . Rules governing the affixing of the CE marking on products with digital elements should be laid down in this Regulation. The CE marking should be the only marking which guarantees that products with digital elements comply with the requirements set out in this Regulation.",
      "tags": [
        "CEMarking",
        "ConformityAssessment",
        "SME"
    ...
    },
    {
      "number": 98,
      "title": "Recital 98",
      "text": "In order to carry out third-party conformity assessment for products with digital elements, conformity assessment bodies should be notified by the national notifying authorities to the Commission and the other Member States, provided they comply with a set of requirements, in particular on independence, competence and absence of conflicts of interest.",
      "tags": [
        "Reporting",
        "ConformityAssessment",
        "SME"
    ...
    },
    {
      "number": 101,
      "title": "Recital 101",
      "text": "Transparent accreditation as provided for in Regulation (EC) No 765/2008, ensuring the necessary level of confidence in certificates of conformity, should be considered by the national public authorities throughout the Union to be the preferred means of demonstrating the technical competence of conformity assessment bodies. However, national authorities may consider that they possess the appropriate means of carrying out that evaluation themselves. In such cases, in order to ensure the appropriate level of credibility of evaluations carried out by other national authorities, they should provide the Commission and the other Member States with the necessary documentary evidence demonstrating the compliance of the conformity assessment bodies evaluated with the relevant regulatory requirements.",
      "tags": [
        "ConformityAssessment",
        "SME"
      ],
    ...
    },
    {
      "number": 102,
      "title": "Recital 102",
      "text": "Conformity assessment bodies frequently subcontract parts of their activities linked to the assessment of conformity or have recourse to a subsidiary. In order to safeguard the level of protection required for a product with digital elements to be placed on the market, it is essential that conformity assessment subcontractors and subsidiaries fulfil the same requirements as notified bodies in relation to the performance of conformity assessment tasks.",
      "tags": [
        "NotifiedBody",
        "ConformityAssessment",
        "SME"
    ...
    },
    {
      "number": 103,
      "title": "Recital 103",
      "text": "The notification of a conformity assessment body should be sent by the notifying authority to the Commission and the other Member States via the New Approach Notified and Designated Organisations (NANDO) information system. The NANDO information system is the electronic notification tool developed and managed by the Commission where a list of all notified bodies can be found.",
      "tags": [
        "Reporting",
        "NotifiedBody",
        "ConformityAssessment",
    ...
    },
    {
      "number": 119,
      "title": "Recital 119",
      "text": "In order to ensure trusting and constructive cooperation of market surveillance authorities at Union and national level, all parties involved in the application of this Regulation should respect the confidentiality of information and data obtained in carrying out their tasks.",
      "tags": [
        "MarketSurveillance"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 121,
      "title": "Recital 121",
      "text": "Where administrative fines are imposed on a person that is not an undertaking, the competent authority should take account of the general level of income in the Member State as well as the economic situation of the person when considering the appropriate amount of the fine. It should be for the Member States to determine whether and to what extent public authorities should be subject to administrative fines.",
      "tags": [
        "Penalties"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 125,
      "title": "Recital 125",
      "text": "The Commission should periodically evaluate and review this Regulation, in consultation with relevant stakeholders, in particular with a view to determining the need for modification in the light of changes to societal, political, technological or market conditions. This Regulation will facilitate the compliance with supply chain security obligations of entities that fall within the scope of Regulation (EU) 2022/2554 and Directive (EU) 2022/2555 that use products with digital elements. The Commission should evaluate, as part of that periodic review, the combined effects of the Union cybersecurity framework.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 129,
      "title": "Recital 129",
      "text": "Since the objective of this Regulation cannot be sufficiently achieved by the Member States but can rather, by reason of the effects of the action, be better achieved at Union level, the Union may adopt measures, in accordance with the principle of subsidiarity as set out in Article 5 of the Treaty on European Union. In accordance with the principle of proportionality as set out in that Article, this Regulation does not go beyond what is necessary in order to achieve that objective.",
      "tags": [],
      "relatedArticles": [
        5
      ],
    ...
    },
    {
      "number": 130,
      "title": "Recital 130",
      "text": "The European Data Protection Supervisor was consulted in accordance with Article 42(1) of Regulation (EU) 2018/1725 of the European Parliament and of the Council and delivered an opinion on 9 November 2022 ,\nHAVE ADOPTED THIS REGULATION:",
      "tags": [],
      "relatedArticles": [
        42
      ],
...
export const articlesData = {
  ...
  "chapters": [
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "This Regulation does not apply to products with digital elements to which the following Union legal acts apply:\n(a) Regulation (EU) 2017/745;\n(b) Regulation (EU) 2017/746;\n(c) Regulation (EU) 2019/2144."
            },
            {
              "paragraphNumber": 3,
              "text": "This Regulation does not apply to products with digital elements that have been certified in accordance with Regulation (EU) 2018/1139."
            },
            {
              "paragraphNumber": 4,
              "text": "This Regulation does not apply to equipment that falls within the scope of Directive 2014/90/EU of the European Parliament and of the Council ."
            },
            {
              "paragraphNumber": 5,
              "text": "The application of this Regulation to products with digital elements covered by other Union rules laying down requirements that address all or some of the risks covered by the essential cybersecurity requirements set out in Annex I may be limited or excluded where:\n(a) such limitation or exclusion is consistent with the overall regulatory framework that applies to those products; and\n(b) the sectoral rules achieve the same or a higher level of protection as that provided for by this Regulation.\nThe Commission is empowered to adopt delegated acts in accordance with Article 61 to supplement this Regulation by specifying whether such limitation or exclusion is necessary, the products and rules concerned, as well as the scope of the limitation, if relevant."
            },
            {
              "paragraphNumber": 6,
              "text": "This Regulation does not apply to spare parts that are made available on the market to replace identical components in products with digital elements and that are manufactured according to the same specifications as the components that they are intended to replace."
            },
            {
              "paragraphNumber": 7,
              "text": "This Regulation does not apply to products with digital elements developed or modified exclusively for national security or defence purposes or to products specifically designed to process classified information."
            },
            {
              "paragraphNumber": 8,
              "text": "The obligations laid down in this Regulation shall not entail the supply of information the disclosure of which would be contrary to the essential interests of Member States’ national security, public security or defence."
            }
          ],
          "tags": [
            "SpareParts"
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "This Regulation shall not prevent Member States from subjecting products with digital elements to additional cybersecurity requirements for the procurement or use of those products for specific purposes, including where those products are procured or used for national security or defence purposes, provided that such requirements are consistent with Member States’ obligations laid down in Union law and that they are necessary and proportionate for the achievement of those purposes."
            },
            {
              "paragraphNumber": 2,
              "text": "Without prejudice to Directives 2014/24/EU and 2014/25/EU, where products with digital elements that fall within the scope of this Regulation are procured, Member States shall ensure that compliance with the essential cybersecurity requirements set out in Annex I to this Regulation, including the manufacturers’ ability to handle vulnerabilities effectively, are taken into consideration in the procurement process."
            }
          ],
          "tags": [
            "VulnerabilityHandling",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "The Commission shall organise regular consultation and information sessions, at least once a year, to gather the views of the stakeholders referred to in paragraph 1 on the implementation of this Regulation."
            }
          ],
          "tags": [
            "OpenSource",
    ...
    },
    {
      ...
      "chapterTitle": "OBLIGATIONS OF ECONOMIC OPERATORS AND PROVISIONS IN RELATION TO FREE AND OPEN-SOURCE SOFTWARE",
      "articlesRange": "Articles 13–26",
      "articles": [
        {
          "articleNumber": 13,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Manufacturers as well as other natural or legal persons may notify any vulnerability contained in a product with digital elements as well as cyber threats that could affect the risk profile of a product with digital elements on a voluntary basis to a CSIRT designated as coordinator or ENISA."
            },
            {
              "paragraphNumber": 2,
              "text": "Manufacturers as well as other natural or legal persons may notify any incident having an impact on the security of the product with digital elements as well as near misses that could have resulted in such an incident on a voluntary basis to a CSIRT designated as coordinator or ENISA."
            },
            {
              "paragraphNumber": 3,
              "text": "The CSIRT designated as coordinator or ENISA shall process the notifications referred to in paragraphs 1 and 2 of this Article in accordance with the procedure laid down in Article 16.\nThe CSIRT designated as coordinator may prioritise the processing of mandatory notifications over voluntary notifications."
            },
            {
              "paragraphNumber": 4,
              "text": "Where a natural or legal person other than the manufacturer notifies an actively exploited vulnerability or a severe incident having an impact on the security of a product with digital elements in accordance with paragraph 1 or 2, the CSIRT designated as coordinator shall without undue delay inform the manufacturer."
            },
            {
              "paragraphNumber": 5,
              "text": "The CSIRTs designated as coordinators as well as ENISA shall ensure the confidentiality and appropriate protection of the information provided by a notifying natural or legal person. Without prejudice to the prevention, investigation, detection and prosecution of criminal offences, voluntary reporting shall not result in the imposition of any additional obligations upon a notifying natural or legal person to which it would not have been subject had it not submitted the notification."
            }
          ],
          "tags": [
            "VulnerabilityHandling",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "ENISA may submit to the European cyber crisis liaison organisation network (EU-CyCLONe) established under Article 16 of Directive (EU) 2022/2555 information notified pursuant to Article 14(1) and (3) and Article 15(1) and (2) of this Regulation if such information is relevant for the coordinated management of large-scale cybersecurity incidents and crises at an operational level. For the purpose of determining such relevance, ENISA may consider technical analyses performed by the CSIRTs network, where available."
            },
            {
              "paragraphNumber": 2,
              "text": "Where public awareness is necessary to prevent or mitigate a severe incident having an impact on the security of the product with digital elements or to handle an ongoing incident, or where disclosure of the incident is otherwise in the public interest, the CSIRT designated as coordinator of the relevant Member State may, after consulting the manufacturer concerned and, where appropriate, in cooperation with ENISA, inform the public about the incident or require the manufacturer to do so."
            },
            {
              "paragraphNumber": 3,
              "text": "ENISA, on the basis of the notifications received pursuant to Article 14(1) and (3) and Article 15(1) and (2) of this Regulation, shall prepare, every 24 months, a technical report on emerging trends regarding cybersecurity risks in products with digital elements and submit it to the Cooperation Group established pursuant to Article 14 of Directive (EU) 2022/2555. The first such report shall be submitted within 24 months of the date of application of the obligations laid down in Article 14(1) and (3) of this Regulation. ENISA shall include relevant information from its technical reports in its report on the state of cybersecurity in the Union pursuant to Article 18 of Directive (EU) 2022/2555."
            },
            {
              "paragraphNumber": 4,
              "text": "The mere act of notification in accordance with Article 14(1) and (3) or Article 15(1) and (2) shall not subject the notifying natural or legal person to increased liability."
            },
            {
              "paragraphNumber": 5,
              "text": "After a security update or another form of corrective or mitigating measure is available, ENISA shall, in agreement with the manufacturer of the product with digital elements concerned, add the publicly known vulnerability notified pursuant to Article 14(1) or Article 15(1) of this Regulation to the European vulnerability database established pursuant to Article 12(2) of Directive (EU) 2022/2555."
            },
            {
              "paragraphNumber": 6,
              "text": "The CSIRTs designated as coordinators shall provide helpdesk support in relation to the reporting obligations pursuant to Article 14 to manufacturers and in particular manufacturers that qualify as microenterprises or as small or medium-sized enterprises."
            }
          ],
          "tags": [
            "VulnerabilityHandling",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "When making a product with digital elements available on the market, distributors shall act with due care in relation to the requirements set out in this Regulation."
            },
            {
              "paragraphNumber": 2,
              "text": "Before making a product with digital elements available on the market, distributors shall verify that:\n(a) the product with digital elements bears the CE marking;\n(b) the manufacturer and the importer have complied with the obligations set out in Article 13(15), (16), (18), (19) and (20) and Article 19(4), and have provided all necessary documents to the distributor."
            },
            {
              "paragraphNumber": 3,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "A natural or legal person, other than the manufacturer, the importer or the distributor, that carries out a substantial modification of a product with digital elements and makes that product available on the market, shall be considered to be a manufacturer for the purposes of this Regulation."
            },
            {
              "paragraphNumber": 2,
              "text": "The person referred to in paragraph 1 of this Article shall be subject to the obligations set out in Articles 13 and 14 for the part of the product with digital elements that is affected by the substantial modification or, if the substantial modification has an impact on the cybersecurity of the product with digital elements as a whole, for the entire product."
            }
          ],
          "tags": [
            "SubstantialModification",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Economic operators shall, on request, provide the market surveillance authorities with the following information:\n(a) the name and address of any economic operator who has supplied them with a product with digital elements;\n(b) where available, the name and address of any economic operator to whom they have supplied a product with digital elements."
            },
            {
              "paragraphNumber": 2,
              "text": "Economic operators shall be able to present the information referred to in paragraph 1 for 10 years after they have been supplied with the product with digital elements and for 10 years after they have supplied the product with digital elements."
            }
          ],
          "tags": [
            "MarketSurveillance"
    ...
    },
    {
      ...
      "chapterTitle": "CONFORMITY OF THE PRODUCT WITH DIGITAL ELEMENTS",
      "articlesRange": "Articles 27–34",
      "articles": [
        {
          "articleNumber": 27,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The EU declaration of conformity shall be drawn up by manufacturers in accordance with Article 13(12) and state that the fulfilment of the applicable essential cybersecurity requirements set out in Annex I has been demonstrated."
            },
            {
              "paragraphNumber": 2,
              "text": "The EU declaration of conformity shall have the model structure set out in Annex V and shall contain the elements specified in the relevant conformity assessment procedures set out in Annex VIII. Such a declaration shall be updated as appropriate. It shall be made available in the languages required by the Member State in which the product with digital elements is placed on the market or made available on the market.\nThe simplified EU declaration of conformity referred to in Article 13(20) shall have the model structure set out in Annex VI. It shall be made available in the languages required by the Member State in which the product with digital elements is placed on the market or made available on the market."
            },
            {
              "paragraphNumber": 3,
              "text": "Where a product with digital elements is subject to more than one Union legal act requiring an EU declaration of conformity, a single EU declaration of conformity shall be drawn up in respect of all such Union legal acts. That declaration shall contain the identification of the Union legal acts concerned, including their publication references."
            },
            {
              "paragraphNumber": 4,
              "text": "By drawing up the EU declaration of conformity, the manufacturer shall assume responsibility for the compliance of the product with digital elements."
            },
            {
              "paragraphNumber": 5,
              "text": "The Commission is empowered to adopt delegated acts in accordance with Article 61 to supplement this Regulation by adding elements to the minimum content of the EU declaration of conformity set out in Annex V to take account of technological developments."
            }
          ],
          "tags": [
            "ConformityAssessment",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The CE marking shall be affixed visibly, legibly and indelibly to the product with digital elements. Where that is not possible or not warranted on account of the nature of the product with digital elements, it shall be affixed to the packaging and to the EU declaration of conformity referred to in Article 28 accompanying the product with digital elements. For products with digital elements which are in the form of software, the CE marking shall be affixed either to the EU declaration of conformity referred to in Article 28 or on the website accompanying the software product. In the latter case, the relevant section of the website shall be easily and directly accessible to consumers."
            },
            {
              "paragraphNumber": 2,
              "text": "On account of the nature of the product with digital elements, the height of the CE marking affixed to the product with digital elements may be lower than 5 mm, provided that it remains visible and legible."
            },
            {
              "paragraphNumber": 3,
              "text": "The CE marking shall be affixed before the product with digital elements is placed on the market. It may be followed by a pictogram or any other mark indicating a special cybersecurity risk or use set out in the implementing acts referred to in paragraph 6."
            },
            {
              "paragraphNumber": 4,
              "text": "The CE marking shall be followed by the identification number of the notified body, where that body is involved in the conformity assessment procedure based on full quality assurance (based on module H) referred to in Article 32.\nThe identification number of the notified body shall be affixed by the body itself or, under its instructions, by the manufacturer or the manufacturer’s authorised representative."
            },
            {
              "paragraphNumber": 5,
              "text": "Member States shall build upon existing mechanisms to ensure correct application of the regime governing the CE marking and shall take appropriate action in the event of improper use of that marking. Where the product with digital elements is subject to Union harmonisation legislation, other than this Regulation, which also provides for the affixing of the CE marking, the CE marking shall indicate that the product also fulfils the requirements set out in such other Union harmonisation legislation."
            },
            {
              "paragraphNumber": 6,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The technical documentation shall contain all relevant data or details of the means used by the manufacturer to ensure that the product with digital elements and the processes put in place by the manufacturer comply with the essential cybersecurity requirements set out in Annex I. It shall at least contain the elements set out in Annex VII."
            },
            {
              "paragraphNumber": 2,
              "text": "The technical documentation shall be drawn up before the product with digital elements is placed on the market and shall be continuously updated, where appropriate, at least during the support period."
            },
            {
              "paragraphNumber": 3,
              "text": "For products with digital elements as referred to in Article 12, which are also subject to other Union legal acts which provide for technical documentation, a single set of technical documentation shall be drawn up containing the information referred to in Annex VII and the information required by those Union legal acts."
            },
            {
              "paragraphNumber": 4,
              "text": "The technical documentation and correspondence relating to any conformity assessment procedure shall be drawn up in an official language of the Member State in which the notified body is established or in a language acceptable to that body."
            },
            {
              "paragraphNumber": 5,
              "text": "The Commission is empowered to adopt delegated acts in accordance with Article 61 to supplement this Regulation by adding elements to be included in the technical documentation set out in Annex VII to take account of technological developments, as well as developments encountered in the implementation process of this Regulation. To that end, the Commission shall strive to ensure that the administrative burden on microenterprises and small and medium-sized enterprises is proportionate."
            }
          ],
          "tags": [
            "NotifiedBody",
      ...
      "articles": [
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Member States shall notify the Commission and the other Member States of bodies authorised to carry out conformity assessments in accordance with this Regulation."
            },
            {
              "paragraphNumber": 2,
              "text": "Member States shall strive to ensure, by 11 December 2026 that there is a sufficient number of notified bodies in the Union to carry out conformity assessments, in order to avoid bottlenecks and hindrances to market entry."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Each Member State shall designate a notifying authority that shall be responsible for setting up and carrying out the necessary procedures for the assessment, designation and notification of conformity assessment bodies and their monitoring, including compliance with Article 41."
            },
            {
              "paragraphNumber": 2,
              "text": "Member States may decide that the assessment and monitoring referred to in paragraph 1 shall be carried out by a national accreditation body within the meaning of and in accordance with Regulation (EC) No 765/2008."
            },
            {
              "paragraphNumber": 3,
              "text": "Where the notifying authority delegates or otherwise entrusts the assessment, notification or monitoring referred to in paragraph 1 of this Article to a body which is not a governmental entity, that body shall be a legal entity and shall comply mutatis mutandis with Article 37. In addition, it shall have arrangements in place to cover liabilities arising from its activities."
            },
            {
              "paragraphNumber": 4,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "A notifying authority shall be established in such a way that no conflict of interest with conformity assessment bodies occurs."
            },
            {
              "paragraphNumber": 2,
              "text": "A notifying authority shall be organised and shall function so as to safeguard the objectivity and impartiality of its activities."
            },
            {
              "paragraphNumber": 3,
              "text": "A notifying authority shall be organised in such a way that each decision relating to notification of a conformity assessment body is taken by competent persons different from those who carried out the assessment."
            },
            {
              "paragraphNumber": 4,
              "text": "A notifying authority shall not offer or provide any activities that conformity assessment bodies perform or consultancy services on commercial or competitive basis."
            },
            {
              "paragraphNumber": 5,
              "text": "A notifying authority shall safeguard the confidentiality of the information it obtains."
            },
            {
              "paragraphNumber": 6,
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "The Commission shall make the information referred to in paragraph 1 publicly available."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Where a notified body subcontracts specific tasks connected with conformity assessment or has recourse to a subsidiary, it shall ensure that the subcontractor or the subsidiary meets the requirements set out in Article 39 and shall inform the notifying authority accordingly."
            },
            {
              "paragraphNumber": 2,
              "text": "Notified bodies shall take full responsibility for the tasks performed by subcontractors or subsidiaries wherever they are established."
            },
            {
              "paragraphNumber": 3,
              "text": "Activities may be subcontracted or carried out by a subsidiary only with the agreement of the manufacturer."
            },
            {
              "paragraphNumber": 4,
              "text": "Notified bodies shall keep at the disposal of the notifying authority the relevant documents concerning the assessment of the qualifications of the subcontractor or the subsidiary and the work carried out by them under this Regulation."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "A conformity assessment body shall submit an application for notification to the notifying authority of the Member State in which it is established."
            },
            {
              "paragraphNumber": 2,
              "text": "That application shall be accompanied by a description of the conformity assessment activities, the conformity assessment procedure or procedures and the product or products with digital elements for which that body claims to be competent, as well as, where applicable, by an accreditation certificate issued by a national accreditation body attesting that the conformity assessment body fulfils the requirements laid down in Article 39."
            },
            {
              "paragraphNumber": 3,
              "text": "Where the conformity assessment body concerned cannot provide an accreditation certificate, it shall provide the notifying authority with all the documentary evidence necessary for the verification, recognition and regular monitoring of its compliance with the requirements laid down in Article 39."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Notifying authorities shall notify only conformity assessment bodies which have satisfied the requirements laid down in Article 39."
            },
            {
              "paragraphNumber": 2,
              "text": "The notifying authority shall notify the Commission and the other Member States using the New Approach Notified and Designated Organisations information system developed and managed by the Commission."
            },
            {
              "paragraphNumber": 3,
              "text": "The notification shall include full details of the conformity assessment activities, the conformity assessment module or modules and product or products with digital elements concerned and the relevant attestation of competence."
            },
            {
              "paragraphNumber": 4,
              "text": "Where a notification is not based on an accreditation certificate as referred to in Article 42(2), the notifying authority shall provide the Commission and the other Member States with documentary evidence which attests to the conformity assessment body’s competence and the arrangements in place to ensure that that body will be monitored regularly and will continue to satisfy the requirements laid down in Article 39."
            },
            {
              "paragraphNumber": 5,
              "text": "The body concerned may perform the activities of a notified body only where no objections are raised by the Commission or the other Member States within two weeks of a notification where an accreditation certificate is used or within two months of a notification where accreditation is not used.\nOnly such a body shall be considered to be a notified body for the purposes of this Regulation."
            },
            {
              "paragraphNumber": 6,
              "text": "The Commission and the other Member States shall be notified of any subsequent relevant changes to the notification."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The Commission shall assign an identification number to a notified body.\nIt shall assign a single such number even where the body is notified under several Union legal acts."
            },
            {
              "paragraphNumber": 2,
              "text": "The Commission shall make publicly available the list of the bodies notified under this Regulation, including the identification numbers that have been allocated to them and the activities for which they have been notified.\nThe Commission shall ensure that that list is kept up to date."
            }
          ],
          "tags": [
            "NotifiedBody"
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The Commission shall investigate all cases where it doubts, or where doubt is brought to its attention regarding, the competence of a notified body to meet, or the continued fulfilment by a notified body of, the requirements and responsibilities to which it is subject."
            },
            {
              "paragraphNumber": 2,
              "text": "The notifying Member State shall provide the Commission, on request, with all information relating to the basis for the notification or the maintenance of the competence of the body concerned."
            },
            {
              "paragraphNumber": 3,
              "text": "The Commission shall ensure that all sensitive information obtained in the course of its investigations is treated confidentially."
            },
            {
              "paragraphNumber": 4,
              "text": "Where the Commission ascertains that a notified body does not meet or no longer meets the requirements for its notification, it shall inform the notifying Member State accordingly and request it to take the necessary corrective measures, including de-notification if necessary."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Notified bodies shall carry out conformity assessments in accordance with the conformity assessment procedures provided for in Article 32 and Annex VIII."
            },
            {
              "paragraphNumber": 2,
              "text": "Conformity assessments shall be carried out in a proportionate manner, avoiding unnecessary burdens for economic operators. Conformity assessment bodies shall perform their activities taking due account of the size of undertakings, in particular as regards microenterprises and small and medium-sized enterprises, the sector in which they operate, their structure, their degree of complexity and the cybersecurity risk level of the products with digital elements and technology in question and the mass or serial nature of the production process."
            },
            {
              "paragraphNumber": 3,
              "text": "Notified bodies shall however respect the degree of rigour and the level of protection required for the compliance of products with digital elements with this Regulation."
            },
            {
              "paragraphNumber": 4,
              "text": "Where a notified body finds that the requirements set out in Annex I or in corresponding harmonised standards or common specifications as referred to in Article 27 have not been met by a manufacturer, it shall require that manufacturer to take appropriate corrective measures and shall not issue a certificate of conformity."
            },
            {
              "paragraphNumber": 5,
              "text": "Where, in the course of the monitoring of conformity following the issuance of a certificate, a notified body finds that a product with digital elements no longer complies with the requirements laid down in this Regulation, it shall require the manufacturer to take appropriate corrective measures and shall suspend or withdraw the certificate if necessary."
            },
            {
              "paragraphNumber": 6,
              "text": "Where corrective measures are not taken or do not have the required effect, the notified body shall restrict, suspend or withdraw any certificates, as appropriate."
            }
          ],
          "tags": [
            "NotifiedBody",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "Notified bodies shall provide the other bodies notified under this Regulation carrying out similar conformity assessment activities covering the same products with digital elements with relevant information on issues relating to negative and, upon request, positive conformity assessment results."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The Commission shall ensure that appropriate coordination and cooperation between notified bodies are put in place and properly operated in the form of a cross-sectoral group of notified bodies."
            },
            {
              "paragraphNumber": 2,
              "text": "Member States shall ensure that the bodies notified by them participate in the work of that group, directly or by means of designated representatives."
            }
          ],
          "tags": [
            "NotifiedBody"
    ...
    },
    {
      ...
      "chapterTitle": "MARKET SURVEILLANCE AND ENFORCEMENT",
      "articlesRange": "Articles 52–60",
      "articles": [
        {
          "articleNumber": 52,
        ...
        {
          "articleNumber": 54,
          "title": "Procedure at national level concerning products with digital elements presenting a significant cybersecurity risk",
          "chapterNumber": 5,
          "chapterTitle": "MARKET SURVEILLANCE AND ENFORCEMENT",
          "paragraphs": [
            {
            ...
            {
              "paragraphNumber": 9,
              "text": "The market surveillance authorities of all Member States shall ensure that appropriate restrictive measures are taken in respect of the product with digital elements concerned, such as withdrawal of that product from their market, without delay."
            }
          ],
          "tags": [
            "VulnerabilityHandling",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "If the national measure is considered to be justified, all Member States shall take the measures necessary to ensure that the non-compliant product with digital elements is withdrawn from their market, and shall inform the Commission accordingly. If the national measure is not considered to be justified, the Member State concerned shall withdraw the measure."
            },
            {
              "paragraphNumber": 3,
              "text": "Where the national measure is considered to be justified and the non-compliance of the product with digital elements is attributed to shortcomings in the harmonised standards, the Commission shall apply the procedure provided for in Article 11 of Regulation (EU) No 1025/2012."
            },
            {
              "paragraphNumber": 4,
              "text": "Where the national measure is considered to be justified and the non-compliance of the product with digital elements is attributed to shortcomings in a European cybersecurity certification scheme as referred to in Article 27, the Commission shall consider whether to amend or repeal any delegated act adopted pursuant to Article 27(9) that specifies the presumption of conformity concerning that certification scheme."
            },
            {
              "paragraphNumber": 5,
              "text": "Where the national measure is considered to be justified and the non-compliance of the product with digital elements is attributed to shortcomings in common specifications as referred to in Article 27, the Commission shall consider whether to amend or repeal any implementing act adopted pursuant to Article 27(2) setting out those common specifications."
            }
          ],
          "tags": [
            "Reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 4,
              "text": "Based on the evaluation referred to in paragraph 3, the Commission may decide that a corrective or restrictive measure is necessary at Union level. To that end, it shall without delay consult the Member States concerned and the relevant economic operator or operators."
            },
            {
              "paragraphNumber": 5,
              "text": "On the basis of the consultation referred to in paragraph 4 of this Article, the Commission may adopt implementing acts to provide for corrective or restrictive measures at Union level, including requiring the products with digital elements concerned to be withdrawn from the market or recalled, within a reasonable period, commensurate with the nature of the risk. Those implementing acts shall be adopted in accordance with the examination procedure referred to in Article 62(2)."
            },
            {
              "paragraphNumber": 6,
              "text": "The Commission shall immediately communicate the implementing acts referred to in paragraph 5 to the relevant economic operator or operators. Member States shall implement those implementing acts without delay and shall inform the Commission accordingly."
            },
            {
              "paragraphNumber": 7,
              "text": "Paragraphs 3 to 6 shall be applicable for the duration of the exceptional situation that justified the Commission’s intervention, provided that the product with digital elements concerned is not brought in compliance with this Regulation."
            }
          ],
          "tags": [
            "MarketSurveillance",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 5,
              "text": "The Commission shall address the decision referred to in paragraph 4 to the Member States."
            },
            {
              "paragraphNumber": 6,
            ...
            {
              "paragraphNumber": 8,
              "text": "Based on the evaluation referred to in paragraph 7, the Commission may establish that a corrective or restrictive measure is necessary at Union level. To that end, it shall without delay consult the Member States concerned and the relevant economic operator or operators."
            },
            {
              "paragraphNumber": 9,
              "text": "On the basis of the consultation referred to in paragraph 8 of this Article, the Commission may adopt implementing acts to decide on corrective or restrictive measures at Union level, including requiring the products with digital elements concerned to be withdrawn from the market, or recalled, within a reasonable period, commensurate with the nature of the risk. Those implementing acts shall be adopted in accordance with the examination procedure referred to in Article 62(2)."
            },
            {
              "paragraphNumber": 10,
              "text": "The Commission shall immediately communicate the implementing acts referred to in paragraph 9 to the relevant economic operator or operators. Member States shall implement those implementing acts without delay and shall inform the Commission accordingly."
            },
            {
              "paragraphNumber": 11,
              "text": "Paragraphs 6 to 10 shall apply for the duration of the exceptional situation that justified the Commission’s intervention and for as long as the product with digital elements concerned continues to present the risks referred to in paragraph 1."
            }
          ],
          "tags": [
            "MarketSurveillance",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Where the market surveillance authority of a Member State makes one of the following findings, it shall require the relevant manufacturer to put an end to the non-compliance concerned:\n(a) the CE marking has been affixed in violation of Articles 29 and 30;\n(b) the CE marking has not been affixed;\n(c) the EU declaration of conformity has not been drawn up;\n(d) the EU declaration of conformity has not been drawn up correctly;\n(e) the identification number of the notified body which is involved in the conformity assessment procedure, where applicable, has not been affixed;\n(f) the technical documentation is either not available or not complete."
            },
            {
              "paragraphNumber": 2,
              "text": "Where the non-compliance referred to in paragraph 1 persists, the Member State concerned shall take all appropriate measures to restrict or prohibit the product with digital elements from being made available on the market or ensure that it is recalled or withdrawn from the market."
            }
          ],
          "tags": [
            "CEMarking",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Market surveillance authorities may agree with other relevant authorities to carry out joint activities aimed at ensuring cybersecurity and the protection of consumers with respect to specific products with digital elements placed on the market or made available on the market, in particular products with digital elements that are often found to present cybersecurity risks."
            },
            {
              "paragraphNumber": 2,
              "text": "The Commission or ENISA shall propose joint activities for checking compliance with this Regulation to be conducted by market surveillance authorities based on indications or information of potential non-compliance across several Member States of products with digital elements that fall within the scope of this Regulation with the requirements laid down in this Regulation."
            },
            {
              "paragraphNumber": 3,
              "text": "The market surveillance authorities and, where applicable, the Commission, shall ensure that the agreement to carry out joint activities does not lead to unfair competition between economic operators and does not negatively affect the objectivity, independence and impartiality of the parties to the agreement."
            },
            {
              "paragraphNumber": 4,
              "text": "A market surveillance authority may use any information obtained as a result of the joint activities carried out as part of any investigation that it undertakes."
            },
            {
              "paragraphNumber": 5,
              "text": "The market surveillance authority concerned and, where applicable, the Commission, shall make the agreement on joint activities, including the names of the parties involved, available to the public."
            }
          ],
          "tags": [
            "MarketSurveillance"
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Market surveillance authorities shall conduct simultaneous coordinated control actions (sweeps) of particular products with digital elements or categories thereof to check compliance with or to detect infringements to this Regulation. Those sweeps may include inspections of products with digital elements acquired under a cover identity."
            },
            {
              "paragraphNumber": 2,
              "text": "Unless otherwise agreed upon by the market surveillance authorities involved, sweeps shall be coordinated by the Commission. The coordinator of the sweep shall, where appropriate, make the aggregated results publicly available."
            },
            {
              "paragraphNumber": 3,
              "text": "Where, in the performance of its tasks, including based on the notifications received pursuant to Article 14(1) and (3), ENISA identifies categories of products with digital elements for which sweeps may be organised, it shall submit a proposal for a sweep to the coordinator referred to in paragraph 2 of this Article for the consideration of the market surveillance authorities."
            },
            {
              "paragraphNumber": 4,
              "text": "When conducting sweeps, the market surveillance authorities involved may use the investigation powers set out in Articles 52 to 58 and any other powers conferred upon them by national law."
            },
            {
              "paragraphNumber": 5,
              "text": "Market surveillance authorities may invite Commission officials, and other accompanying persons authorised by the Commission, to participate in sweeps."
            }
          ],
          "tags": [
            "Reporting",
      ...
      "articles": [
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 3,
              "text": "The delegation of power referred to in Article 2(5), second subparagraph, Article 7(3), Article 8(1) and (2), Article 13(8), fourth subparagraph, Article 14(9), Article 25, Article 27(9), Article 28(5) and Article 31(5) may be revoked at any time by the European Parliament or by the Council. A decision to revoke shall put an end to the delegation of the power specified in that decision. It shall take effect the day following the publication of the decision in the Official Journal of the European Union or at a later date specified therein. It shall not affect the validity of any delegated acts already in force."
            },
            {
              "paragraphNumber": 4,
              "text": "Before adopting a delegated act, the Commission shall consult experts designated by each Member State in accordance with principles laid down in the Interinstitutional Agreement of 13 April 2016 on Better Law-Making."
            },
            {
              "paragraphNumber": 5,
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 3,
              "text": "Where the opinion of the committee is to be obtained by written procedure, that procedure shall be terminated without result when, within the time-limit for delivery of the opinion, the chair of the committee so decides or a committee member so requests."
            }
          ],
          "tags": [],
          "referencedArticles": [
      ...
      "articles": [
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "All parties involved in the application of this Regulation shall respect the confidentiality of information and data obtained in carrying out their tasks and activities in such a manner as to protect, in particular:\n(a) intellectual property rights and confidential business information or trade secrets of a natural or legal person, including source code, except the cases referred to in Article 5 of Directive (EU) 2016/943 of the European Parliament and of the Council ;\n(b) the effective implementation of this Regulation, in particular for the purposes of inspections, investigations or audits;\n(c) public and national security interests;\n(d) integrity of criminal or administrative proceedings."
            },
            {
              "paragraphNumber": 2,
              "text": "Without prejudice to paragraph 1, information exchanged on a confidential basis between the market surveillance authorities and between market surveillance authorities and the Commission shall not be disclosed without the prior agreement of the originating market surveillance authority."
            },
            {
              "paragraphNumber": 3,
              "text": "Paragraphs 1 and 2 shall not affect the rights and obligations of the Commission, Member States and notified bodies with regard to the exchange of information and the dissemination of warnings, nor the obligations of the persons concerned to provide information under criminal law of the Member States."
            },
            {
              "paragraphNumber": 4,
              "text": "The Commission and Member States may exchange, where necessary, sensitive information with relevant authorities of third countries with which they have concluded bilateral or multilateral confidentiality arrangements guaranteeing an adequate level of protection."
            }
          ],
          "tags": [
            "NotifiedBody",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 5,
              "text": "When deciding on the amount of the administrative fine in each individual case, all relevant circumstances of the specific situation shall be taken into account and due regard shall be given to the following:\n(a) the nature, gravity and duration of the infringement and of its consequences;\n(b) whether administrative fines have been already applied by the same or other market surveillance authorities to the same economic operator for a similar infringement;\n(c) the size, in particular with regard to microenterprises and small and medium sized-enterprises, including start-ups, and the market share of the economic operator committing the infringement."
            },
            {
              "paragraphNumber": 6,
              "text": "Market surveillance authorities that apply administrative fines shall communicate that application to the market surveillance authorities of other Member States through the information and communication system referred to in Article 34 of Regulation (EU) 2019/1020."
            },
            {
              "paragraphNumber": 7,
              "text": "Each Member State shall lay down rules on whether and to what extent administrative fines may be imposed on public authorities and public bodies established in that Member State."
            },
            {
              "paragraphNumber": 8,
              "text": "Depending on the legal system of the Member States, the rules on administrative fines may be applied in such a manner that the fines are imposed by competent national courts or other bodies according to the competences established at national level in those Member States. The application of such rules in those Member States shall have an equivalent effect."
            },
            {
              "paragraphNumber": 9,
              "text": "Administrative fines may be imposed, depending on the circumstances of each individual case, in addition to any other corrective or restrictive measures applied by the market surveillance authorities for the same infringement."
            },
            {
              "paragraphNumber": 10,
              "text": "By way of derogation from paragraphs 2 to 9, the administrative fines referred to in those paragraphs shall not apply to the following:\n(a) manufacturers that qualify as microenterprises or small enterprises with regard to any failure to meet the deadline referred to in Article 14(2), point (a), or Article 14(4), point (a);\n(b) any infringement of this Regulation by open-source software stewards."
            }
          ],
          "tags": [
            "Reporting",
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "In Part C1, in the table, of Annex II to Regulation (EU) No 168/2013 of the European Parliament and of the Council , the following entry is added:\n‘\n16 18 protection of vehicle against cyberattacks  x x x x x x x x x x x x x x\n’."
            }
          ],
          "tags": [],
          "referencedArticles": [],
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "EU type-examination certificates and approval decisions issued regarding cybersecurity requirements for products with digital elements that are subject to Union harmonisation legislation other than this Regulation shall remain valid until 11 June 2028, unless they expire before that date, or unless otherwise specified in such other Union harmonisation legislation, in which case they shall remain valid as referred to in that legislation."
            },
            {
              "paragraphNumber": 2,
              "text": "Products with digital elements that have been placed on the market before 11 December 2027 shall be subject to the requirements set out in this Regulation only if, from that date, those products are subject to a substantial modification."
            },
            {
              "paragraphNumber": 3,
              "text": "By way of derogation from paragraph 2 of this Article, the obligations laid down in Article 14 shall apply to all products with digital elements that fall within the scope of this Regulation that have been placed on the market before 11 December 2027."
            }
          ],
          "tags": [
            "SubstantialModification"
  ...
  "annexes": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        "8. detailed instructions or an internet address referring to such detailed instructions and information on: (a) the necessary measures during initial commissioning and throughout the lifetime of the product with digital elements to ensure its secure use;",
    ...
    {
      "annexNumber": "VI",
      "title": "SIMPLIFIED EU DECLARATION OF CONFORMITY",
      "blocks": [
    ...
    {
      "annexNumber": "VII",
      "title": "CONTENT OF THE TECHNICAL DOCUMENTATION",
      "blocks": [
        ...
        "1. a general description of the product with digital elements, including: (a) its intended purpose;",
    ...
    },
    {
      ...
      "blocks": [
        ...
        "4. Conformity marking and declaration of conformity 4.1. The manufacturer shall affix the CE marking to each individual product with digital elements that satisfies the applicable requirements set out in this Regulation.",
        ...
        "3. Conformity marking and declaration of conformity 3.1. The manufacturer shall affix the CE marking to each individual product with digital elements that is in conformity with the type described in the EU-type examination certificate and satisfies the applicable requirements set out in this Regulation.",
        ...
        "4.2. The manufacturer shall, for assessment purposes, allow the notified body access to the design, development, production, inspection, testing and storage sites, and shall provide it with all necessary information, in particular: (a) the quality system documentation;",
        ...
        "6. The manufacturer shall, for a period ending at least 10 years after the product with digital elements has been placed on the market or for the support period, whichever is longer, keep at the disposal of the national authorities: (a) the technical documentation referred to in point 3.1;",
...
export const graphData = {
  ...
  "edges": [
    ...
    },
    {
      "source": "ARTICLE_2",
      "target": "ARTICLE_61",
      "type": "article_refers_article"
    },
    {
      "source": "ARTICLE_2",
      "target": "ANNEX_I",
      "type": "article_refers_annex"
    },
    {
      "source": "ARTICLE_3",
      "target": "ARTICLE_2",
