...
podcastStudioRouter.get("/podcast/episodes", (req: Request, res: Response) => {
  try {
    ...
    const truthEpisodes = [
      ...
      { id: "TC_04", code: "TC_04", episodeNumber: 4, title: "The €15M Calculation: Dissecting the Math Behind Article 61 Global Turnover Penalties", category: "truth", statutes: ["Article 61", "Recital 78"], persona: "Chief Financial Officers & General Counsel", duration: "14:40" },
