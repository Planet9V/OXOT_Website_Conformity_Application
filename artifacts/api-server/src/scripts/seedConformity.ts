 ...
 */
const red: Req[] = [
  { refCode: "Art 3(3)(d)", themeKey: "resilience", title: "Protection of the network", description: "Radio equipment within the categories designated by Delegated Regulation (EU) 2022/30 shall be so constructed that it does not harm the network or its functioning nor misuse network resources, thereby causing an unacceptable degradation of service.", obligationType: "product_requirement", appliesTo: ["manufacturer"] },
  { refCode: "Art 3(3)(e)", themeKey: "data_protection", title: "Safeguards for personal data and privacy", description: "Radio equipment within the designated categories shall incorporate safeguards to ensure that the personal data and privacy of the user and of the subscriber are protected.", obligationType: "product_requirement", appliesTo: ["manufacturer"] },
  { refCode: "Art 3(3)(f)", themeKey: "access_control", title: "Protection from fraud", description: "Radio equipment within the designated categories shall support certain features ensuring protection from fraud.", obligationType: "product_requirement", appliesTo: ["manufacturer"] },
