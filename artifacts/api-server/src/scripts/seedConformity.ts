...
const aiAct: Req[] = [
  { refCode: "Art 9", themeKey: "risk_management", title: "Risk management system", description: "Establish, implement, document and maintain a risk management system running throughout the entire lifecycle of the high-risk AI system.", obligationType: "process", appliesTo: ["provider"] },
  { refCode: "Art 10", themeKey: "data_governance", title: "Data and data governance", description: "Training, validation and testing data sets shall be subject to data governance and management practices appropriate to the intended purpose.", obligationType: "process", appliesTo: ["provider"] },
  { refCode: "Art 11", themeKey: "technical_documentation", title: "Technical documentation (Annex IV)", description: "Draw up technical documentation before the system is placed on the market and keep it up to date, demonstrating conformity as set out in Annex IV.", obligationType: "documentation", appliesTo: ["provider"] },
  { refCode: "Art 12", themeKey: "logging_monitoring", title: "Record-keeping and logging", description: "High-risk AI systems shall technically allow for the automatic recording of events (logs) over the lifetime of the system.", obligationType: "product_requirement", appliesTo: ["provider"] },
  { refCode: "Art 13", themeKey: "human_oversight", title: "Transparency and information to deployers", description: "Design and develop systems so that operation is sufficiently transparent to enable deployers to interpret output and use it appropriately; provide instructions for use.", obligationType: "documentation", appliesTo: ["provider"] },
  { refCode: "Art 14", themeKey: "human_oversight", title: "Human oversight", description: "Design and develop high-risk AI systems so that they can be effectively overseen by natural persons during the period in which they are in use.", obligationType: "product_requirement", appliesTo: ["provider"] },
  { refCode: "Art 15", themeKey: "resilience", title: "Accuracy, robustness and cybersecurity", description: "Design and develop systems to achieve appropriate levels of accuracy, robustness and cybersecurity, performing consistently throughout their lifecycle.", obligationType: "product_requirement", appliesTo: ["provider"] },
  { refCode: "Art 15(5)", themeKey: "resilience", title: "Resilience against manipulation", description: "High-risk AI systems shall be resilient against attempts to alter their use, outputs or performance by exploiting vulnerabilities, including data poisoning and adversarial examples.", obligationType: "product_requirement", appliesTo: ["provider"] },
  { refCode: "Art 17", themeKey: "risk_management", title: "Quality management system", description: "Providers shall put in place a quality management system that ensures compliance with the Regulation, documented in a systematic and orderly manner.", obligationType: "governance", appliesTo: ["provider"] },
  { refCode: "Art 47", themeKey: "conformity_declaration", title: "EU declaration of conformity", description: "Draw up a written EU declaration of conformity for each high-risk AI system and keep it for ten years after placing on the market.", obligationType: "documentation", appliesTo: ["provider"] },
  { refCode: "Art 72", themeKey: "post_market", title: "Post-market monitoring", description: "Establish and document a post-market monitoring system that actively collects and reviews experience gained from the use of high-risk AI systems.", obligationType: "process", appliesTo: ["provider"] },
  { refCode: "Art 73", themeKey: "incident_reporting", title: "Reporting of serious incidents", description: "Report any serious incident to the market surveillance authorities of the Member States concerned, within the deadlines set out in the Regulation.", obligationType: "reporting", appliesTo: ["provider"] },
];
...
const iec: Req[] = [
  { refCode: "4-1 SM", themeKey: "risk_management", title: "Security management", description: "Establish a security management process governing the development lifecycle, including roles, responsibilities and a defined scope of the process.", obligationType: "process", appliesTo: ["supplier"] },
  { refCode: "4-1 SM-9", themeKey: "sbom_supply_chain", title: "Third-party component management", description: "Identify, assess and manage security risks of third-party and open-source components used in the product, maintaining a record of components.", obligationType: "process", appliesTo: ["supplier"] },
  { refCode: "4-1 SR", themeKey: "secure_by_design", title: "Specification of security requirements", description: "Document and maintain security requirements for the product, derived from its intended environment and threat model.", obligationType: "process", appliesTo: ["supplier"] },
  { refCode: "4-1 SD", themeKey: "secure_by_design", title: "Secure by design", description: "Apply secure design principles, including defence in depth and threat modelling, throughout product design.", obligationType: "process", appliesTo: ["supplier"] },
  { refCode: "4-1 SVV", themeKey: "vulnerability_handling", title: "Security verification and validation", description: "Perform security verification and validation testing, including threat mitigation, vulnerability and penetration testing, before release.", obligationType: "process", appliesTo: ["supplier"] },
  { refCode: "4-1 DM", themeKey: "vulnerability_handling", title: "Management of security-related issues", description: "Establish a process to receive, track, assess and remediate security-related issues (defects and vulnerabilities) in the product.", obligationType: "process", appliesTo: ["supplier"] },
  { refCode: "4-1 SUM", themeKey: "secure_update", title: "Security update management", description: "Establish a process to develop, test, qualify and securely deliver security updates to product users in a timely manner.", obligationType: "process", appliesTo: ["supplier"] },
  { refCode: "4-1 SG", themeKey: "technical_documentation", title: "Security guidelines", description: "Provide documentation (security guidelines) enabling the secure integration, configuration, operation, maintenance and decommissioning of the product.", obligationType: "documentation", appliesTo: ["supplier"] },
  { refCode: "4-2 FR1", themeKey: "access_control", title: "Identification and authentication control", description: "Identify and authenticate all users (humans, software processes and devices) before allowing access to the component.", obligationType: "product_requirement", appliesTo: ["supplier"] },
  { refCode: "4-2 FR2", themeKey: "access_control", title: "Use control", description: "Enforce assigned privileges to restrict use of the component to authorised actions (authorization).", obligationType: "product_requirement", appliesTo: ["supplier"] },
  { refCode: "4-2 FR3", themeKey: "data_protection", title: "System integrity", description: "Protect the integrity of the component against unauthorised manipulation, including of firmware, software and information.", obligationType: "product_requirement", appliesTo: ["supplier"] },
  { refCode: "4-2 FR4", themeKey: "data_protection", title: "Data confidentiality", description: "Protect the confidentiality of information at rest and in transit, including through cryptographic protection.", obligationType: "product_requirement", appliesTo: ["supplier"] },
  { refCode: "4-2 FR6", themeKey: "logging_monitoring", title: "Timely response to events", description: "Provide audit logging and the capability to respond to security violations by notifying the proper authority and reporting evidence.", obligationType: "product_requirement", appliesTo: ["supplier"] },
  { refCode: "4-2 FR7", themeKey: "resilience", title: "Resource availability", description: "Ensure availability of the component against the degradation or denial of essential services, including under denial-of-service conditions.", obligationType: "product_requirement", appliesTo: ["supplier"] },
  // 62443-3-3 — system security requirements (SRs), organised under the seven foundational requirements at the system/IACS level.
  { refCode: "3-3 SR 1.1", themeKey: "access_control", title: "Human user identification and authentication", description: "The control system shall identify and authenticate all human users, and enforce authentication on all interfaces, before allowing access to the system.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 1.2", themeKey: "access_control", title: "Software process and device identification", description: "The control system shall identify and authenticate all software processes and devices before allowing them to access the system.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 2.1", themeKey: "access_control", title: "Authorization enforcement", description: "The control system shall enforce authorizations assigned to all users and processes, restricting access to the minimum necessary for the assigned role (least privilege).", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 2.5", themeKey: "access_control", title: "Session lock and termination", description: "The control system shall lock or terminate a session after a configurable period of inactivity or on demand, preventing further access until re-authentication.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 3.1", themeKey: "data_protection", title: "Communication integrity", description: "The control system shall protect the integrity of transmitted information, detecting unauthorised changes to communications during transmission.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 3.2", themeKey: "data_protection", title: "Malicious code protection", description: "The control system shall provide protection against, and detection of, malicious code at entry and exit points and on affected devices.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 4.1", themeKey: "data_protection", title: "Information confidentiality", description: "The control system shall protect the confidentiality of information at rest and in transit for which explicit read authorization is required, using cryptographic mechanisms where appropriate.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 5.1", themeKey: "secure_by_design", title: "Network segmentation", description: "The control system shall logically segment control networks from non-control networks and partition the system into zones and conduits according to the risk assessment.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 5.2", themeKey: "secure_by_design", title: "Zone boundary protection", description: "The control system shall monitor and control communications at zone boundaries to enforce the defined conduits, denying network traffic by default and allowing it by exception.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 6.1", themeKey: "logging_monitoring", title: "Audit log accessibility", description: "The control system shall provide the capability to access audit logs on a read-only basis to authorised personnel and tools.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 6.2", themeKey: "logging_monitoring", title: "Continuous monitoring", description: "The control system shall provide the capability to continuously monitor security-relevant events using commonly accepted tools and mechanisms.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 7.1", themeKey: "resilience", title: "Denial-of-service protection", description: "The control system shall maintain essential functions when operating in a degraded mode as the result of a denial-of-service event.", obligationType: "product_requirement", appliesTo: ["integrator"] },
  { refCode: "3-3 SR 7.2", themeKey: "resilience", title: "Resource management and recovery", description: "The control system shall limit the use of resources by security functions to prevent resource exhaustion, and support backup and recovery to a known secure state after a disruption.", obligationType: "product_requirement", appliesTo: ["integrator"] },
];
