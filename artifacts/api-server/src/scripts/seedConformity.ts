...
const red: Req[] = [
  ...
  { refCode: "Art 10(8)", themeKey: "technical_documentation", title: "Instructions and safety information", description: "Ensure the equipment is accompanied by instructions and safety information in a language easily understood by consumers and other end-users, including where applicable a description of accessories and components (including software) that allow intended operation and, for intentionally emitting equipment, the frequency bands and maximum radio-frequency power transmitted. As replaced by Directive (EU) 2022/2380: for equipment under Art 3(4), the instructions state the charging capabilities and compatible charging devices (Annex Ia Part II), with the Part IV label printed in the instructions and on or affixed to the packaging, displayed visibly and, in distance selling, close to the price indication.", obligationType: "documentation", appliesTo: ["manufacturer"] },
  ...
  { refCode: "Art 13(2)", themeKey: null, title: "Verify before making available", description: "Before making radio equipment available, verify that it bears the CE marking, is accompanied by the documents required by the Directive and by instructions and safety information in a language easily understood in the Member State concerned, and that the manufacturer and the importer have met their identification and information duties; where equipment is not in conformity do not make it available, and where it presents a risk inform the manufacturer or importer and the market surveillance authorities. As added by Directive (EU) 2022/2380: for Art 3(4) equipment made available to consumers, ensure the Art 10(8) charging label is displayed or supplied, visibly and legibly and, in distance selling, close to the price indication.", obligationType: "process", appliesTo: ["distributor"] },
