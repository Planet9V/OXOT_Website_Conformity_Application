...
export const PERSONA_CONFIGS: Record<PersonaId, PersonaConfig> = {
  INTEGRATOR: {
    ...
    tagline: 'Shield your engineering firm from Article 21 manufacturer reclassification while modernizing customer OT plants.',
    statutoryBasis: 'Article 21(2) & Recital 34 (Spare Parts & Integrator Safe Harbor)',
    statutoryRefCode: 'Art. 21 & Recital 34',
    liabilityShieldStatus: 'Active: Recital 34 Safe Harbor Shield Enabled',
    kpis: [
      { label: 'Customer OT Plants', value: '3 Active Facilities', subtext: 'Rotterdam, Antwerp, Sochaux', tone: 'text-foreground font-bold' },
      { label: 'Recital 34 Safe Harbor', value: '100% Protected', subtext: 'Cryptographic SHA-256 Certs Issued', tone: 'text-emerald-500 font-bold' },
      { label: 'Duty to Refrain Blocks', value: '2 OEM Equipment Lines', subtext: 'Held under Article 18(2)', tone: 'text-amber-500 font-bold' },
      { label: 'Protected Turnover', value: '€285,000,000', subtext: 'Zero Manufacturer Liability', tone: 'text-primary font-bold' },
    ],
    interactiveWorkstation: {
  ...
  MANUFACTURER: {
    ...
    statutoryBasis: 'Articles 10, 13, 22, 23 & Annex I (Essential Cybersecurity Properties)',
    statutoryRefCode: 'Art. 10 & Annex I',
    liabilityShieldStatus: 'Article 10 Full Security-by-Design Compliance',
    kpis: [
  ...
  STEWARD: {
    ...
    tagline: 'Issue Article 33 voluntary security attestations and OpenVEX disclosures without commercial liability.',
    statutoryBasis: 'Article 33 & Recital 18 (Open Source Software Stewards Exemption)',
    statutoryRefCode: 'Art. 33 & Recital 18',
    liabilityShieldStatus: 'Exempt from Commercial Manufacturer Obligations',
    kpis: [
      { label: 'FOSS Repositories', value: '6 Open Repositories', subtext: 'Industrial OT Protocols & Stacks', tone: 'text-foreground font-bold' },
      { label: 'Article 33 Attestation', value: 'Signed & Active', subtext: 'Legal Liability Exemption Granted', tone: 'text-purple-400 font-bold' },
    ...
    interactiveWorkstation: {
      ...
      highlights: [
        { label: 'Recital 18 Non-Commercial Standing', value: 'Certified Non-Commercial', status: 'good' },
  ...
  IMPORTER: {
    ...
    statutoryBasis: 'Articles 17, 18, 19 (Importer & Distributor 10-Year Archiving Mandate)',
    statutoryRefCode: 'Arts. 17 & 19',
    liabilityShieldStatus: '10-Year Statutory Evidence Vault Maintained for MSAs',
    kpis: [
  ...
  PLANT_CISO: {
    ...
    tagline: 'Prove NIS2 supply chain cybersecurity conformity and model Article 61 fine exposures.',
    statutoryBasis: 'Article 61 (€15M / 2.5% Fines) & NIS2 Directive Cross-Compliance',
    statutoryRefCode: 'Art. 61 & NIS2',
    liabilityShieldStatus: 'NIS2 Art. 21 & CRA Supply Chain Compliance Verified',
    kpis: [
  ...
  AUDITOR: {
    ...
    liabilityShieldStatus: 'Third-Party Independent Notified Body Examination Active',
    kpis: [
