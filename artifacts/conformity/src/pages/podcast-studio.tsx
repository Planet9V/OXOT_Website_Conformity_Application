...
export default function PodcastStudioPage() {
  ...
  const episodes: Episode[] = useMemo(() => [
    ...
    { id: 'EP_2.02', code: 'EP_2.02', title: "Article 20(2) Duty to Refrain: When Integrators Must Freeze Customer Deployments", category: 'standard', statutes: ['Article 20(2)', 'Article 19'], persona: 'Lead Automation Engineers', duration: '14:05', audioUrl: 'https://oxot.ai/audio/cra_podcast/EP_2.02.mp3', summary: 'The statutory obligation to halt commissioning when known unpatched critical vulnerabilities are detected.' },
    ...
    { id: 'EP_4.01', code: 'EP_4.01', title: 'The Tier-2 Dilemma: How Embedded Board Makers Survive Without Full CE Marks', category: 'standard', statutes: ['Article 22', 'Article 29', 'Recital 19'], persona: 'Embedded Hardware Suppliers', duration: '14:15', audioUrl: 'https://oxot.ai/audio/cra_podcast/EP_4.01.mp3', summary: 'How component suppliers supply compliant subsystems to Tier-1 OEMs without bearing full CE marking liability.' },
    ...
    { id: 'EP_8.01', code: 'EP_8.01', title: 'The €15M Calculation: Demystifying Article 64 Turnover Fines', category: 'standard', statutes: ['Article 64', 'Recital 78'], persona: 'CEOs, CFOs & General Counsel', duration: '14:40', audioUrl: 'https://oxot.ai/audio/cra_podcast/EP_8.01.mp3', summary: 'How European market surveillance calculates the 2.5% global turnover fine and officer liability.' },
