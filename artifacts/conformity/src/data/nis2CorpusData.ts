/**
 * NIS2 statutory corpus — Directive (EU) 2022/2555.
 *
 * GENERATED FILE — DO NOT EDIT BY HAND.
 * Built from the Official Journal text (OJ L 333, 27.12.2022, p. 80,
 * CELEX 32022L2555) by scripts/build_nis2_corpus_from_eurlex.mjs and
  ...
  "recitals": [
    {
      "number": 1,
      "title": "Recital 1",
      "text": "Directive (EU) 2016/1148 of the European Parliament and the Council aimed to build cybersecurity capabilities across the Union, mitigate threats to network and information systems used to provide essential services in key sectors and ensure the continuity of such services when facing incidents, thus contributing to the Union’s security and to the effective functioning of its economy and society.",
      "tags": [
        "incident_reporting"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 17,
      "title": "Recital 17",
      "text": "Member States should be able to decide that entities identified before the entry into force of this Directive as operators of essential services in accordance with Directive (EU) 2016/1148 are to be considered to be essential entities.",
      "tags": [
        "entity_classification"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 26,
      "title": "Recital 26",
      "text": "Where sector-specific Union legal acts require or provide incentives to entities to notify significant cyber threats, Member States should also encourage the sharing of significant cyber threats with the CSIRTs, the competent authorities or the single points of contact under this Directive, in order to ensure an enhanced level of those bodies’ awareness of the cyber threat landscape and to enable them to respond effectively and in a timely manner should the significant cyber threats materialise.",
      "tags": [
        "csirt"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 27,
      "title": "Recital 27",
      "text": "Future sector-specific Union legal acts should take due account of the definitions and the supervisory and enforcement framework laid down in this Directive.",
      "tags": [
        "supervision_enforcement"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 63,
      "title": "Recital 63",
      "text": "Although similar vulnerability registries or databases exist, they are hosted and maintained by entities which are not established in the Union. A European vulnerability database maintained by ENISA would provide improved transparency regarding the publication process before the vulnerability is publicly disclosed, and resilience in the event of a disruption or an interruption of the provision of similar services. In order, to the extent possible, to avoid a duplication of efforts and to seek complementarity, ENISA should explore the possibility of entering into structured cooperation agreements with similar registries or databases that fall under third-country jurisdiction. In particular, ENISA should explore the possibility of close cooperation with the operators of the Common Vulnerabilities and Exposures (CVE) system.",
      "tags": [
        "registration",
        "vulnerability_handling",
        "jurisdiction"
    ...
    },
    {
      "number": 87,
      "title": "Recital 87",
      "text": "The competent authorities, in the context of their supervisory tasks, may also benefit from cybersecurity services such as security audits, penetration testing or incident responses.",
      "tags": [
        "incident_reporting",
        "supervision_enforcement"
      ],
    ...
    },
    {
      "number": 108,
      "title": "Recital 108",
      "text": "Personal data are in many cases compromised as a result of incidents. In that context, the competent authorities should cooperate and exchange information about all relevant matters with the authorities referred to in Regulation (EU) 2016/679 and Directive 2002/58/EC.",
      "tags": [
        "incident_reporting"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 126,
      "title": "Recital 126",
      "text": "In duly substantiated cases where it is aware of a significant cyber threat or an imminent risk, the competent authority should be able to take immediate enforcement decisions with the aim of preventing or responding to an incident.",
      "tags": [
        "incident_reporting",
        "supervision_enforcement"
      ],
    ...
    },
    {
      "number": 128,
      "title": "Recital 128",
      "text": "This Directive does not require Member States to provide for criminal or civil liability with regard to natural persons with responsibility for ensuring that an entity complies with this Directive for damage suffered by third parties as a result of an infringement of this Directive.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    {
      "number": 129,
      "title": "Recital 129",
      "text": "In order to ensure effective enforcement of the obligations laid down in this Directive, each competent authority should have the power to impose or request the imposition of administrative fines.",
      "tags": [
        "supervision_enforcement"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 136,
      "title": "Recital 136",
      "text": "This Directive should establish cooperation rules between the competent authorities and the supervisory authorities under Regulation (EU) 2016/679 to deal with infringements of this Directive related to personal data.",
      "tags": [
        "supervision_enforcement"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 144,
      "title": "Recital 144",
      "text": "The European Data Protection Supervisor was consulted in accordance with Article 42(1) of Regulation (EU) 2018/1725 of the European Parliament and of the Council and delivered an opinion on 11 March 2021 ,\nHAVE ADOPTED THIS DIRECTIVE:",
      "tags": [
        "supervision_enforcement"
      ],
      "relatedArticles": [
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "Regardless of their size, this Directive also applies to entities of a type referred to in Annex I or II, where:\n(a) services are provided by: (i) providers of public electronic communications networks or of publicly available electronic communications services;\n(ii) trust service providers;\n(iii) top-level domain name registries and domain name system service providers;\n(b) the entity is the sole provider in a Member State of a service which is essential for the maintenance of critical societal or economic activities;\n(c) disruption of the service provided by the entity could have a significant impact on public safety, public security or public health;\n(d) disruption of the service provided by the entity could induce a significant systemic risk, in particular for sectors where such disruption could have a cross-border impact;\n(e) the entity is critical because of its specific importance at national or regional level for the particular sector or type of service, or for other interdependent sectors in the Member State;\n(f) the entity is a public administration entity: (i) of central government as defined by a Member State in accordance with national law; or\n(ii) at regional level as defined by a Member State in accordance with national law that, following a risk-based assessment, provides services the disruption of which could have a significant impact on critical societal or economic activities."
            },
            {
              "paragraphNumber": 3,
              "text": "Regardless of their size, this Directive applies to entities identified as critical entities under Directive (EU) 2022/2557."
            },
            {
              "paragraphNumber": 4,
              "text": "Regardless of their size, this Directive applies to entities providing domain name registration services."
            },
            {
              "paragraphNumber": 5,
              "text": "Member States may provide for this Directive to apply to:\n(a) public administration entities at local level;\n(b) education institutions, in particular where they carry out critical research activities."
            },
            {
              "paragraphNumber": 6,
              "text": "This Directive is without prejudice to the Member States’ responsibility for safeguarding national security and their power to safeguard other essential State functions, including ensuring the territorial integrity of the State and maintaining law and order."
            },
            {
              "paragraphNumber": 7,
              "text": "This Directive does not apply to public administration entities that carry out their activities in the areas of national security, public security, defence or law enforcement, including the prevention, investigation, detection and prosecution of criminal offences."
            },
            {
              "paragraphNumber": 8,
              "text": "Member States may exempt specific entities which carry out activities in the areas of national security, public security, defence or law enforcement, including the prevention, investigation, detection and prosecution of criminal offences, or which provide services exclusively to the public administration entities referred to in paragraph 7 of this Article, from the obligations laid down in Article 21 or 23 with regard to those activities or services. In such cases, the supervisory and enforcement measures referred to in Chapter VII shall not apply in relation to those specific activities or services. Where the entities carry out activities or provide services exclusively of the type referred to in this paragraph, Member States may decide also to exempt those entities from the obligations laid down in Articles 3 and 27."
            },
            {
              "paragraphNumber": 9,
              "text": "Paragraphs 7 and 8 shall not apply where an entity acts as a trust service provider."
            },
            {
              "paragraphNumber": 10,
              "text": "This Directive does not apply to entities which Member States have exempted from the scope of Regulation (EU) 2022/2554 in accordance with Article 2(4) of that Regulation."
            },
            {
              "paragraphNumber": 11,
              "text": "The obligations laid down in this Directive shall not entail the supply of information the disclosure of which would be contrary to the essential interests of Member States’ national security, public security or defence."
            },
            {
              "paragraphNumber": 12,
              "text": "This Directive applies without prejudice to Regulation (EU) 2016/679, Directive 2002/58/EC, Directives 2011/93/EU and 2013/40/EU of the European Parliament and of the Council and Directive (EU) 2022/2557."
            },
            {
              "paragraphNumber": 13,
              "text": "Without prejudice to Article 346 TFEU, information that is confidential pursuant to Union or national rules, such as rules on business confidentiality, shall be exchanged with the Commission and other relevant authorities in accordance with this Directive only where that exchange is necessary for the application of this Directive. The information exchanged shall be limited to that which is relevant and proportionate to the purpose of that exchange. The exchange of information shall preserve the confidentiality of that information and protect the security and commercial interests of entities concerned."
            },
            {
              "paragraphNumber": 14,
              "text": "Entities, the competent authorities, the single points of contact and the CSIRTs shall process personal data to the extent necessary for the purposes of this Directive and in accordance with Regulation (EU) 2016/679, in particular such processing shall rely on Article 6 thereof.\nThe processing of personal data pursuant to this Directive by providers of public electronic communications networks or providers of publicly available electronic communications services shall be carried out in accordance with Union data protection law and Union privacy law, in particular Directive 2002/58/EC."
            }
          ],
          "tags": [
            "csirt",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "This Directive shall not preclude Member States from adopting or maintaining provisions ensuring a higher level of cybersecurity, provided that such provisions are consistent with Member States’ obligations laid down in Union law."
            }
          ],
          "tags": [],
          "referencedArticles": [],
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "By 17 October 2024, Member States shall adopt and publish the measures necessary to comply with this Directive. They shall immediately inform the Commission thereof.\nThey shall apply those measures from 18 October 2024."
            },
            {
              "paragraphNumber": 2,
              "text": "When Member States adopt the measures referred to in paragraph 1, they shall contain a reference to this Directive or shall be accompanied by such reference on the occasion of their official publication. The methods of making such reference shall be laid down by Member States."
            }
          ],
          "tags": [],
          "referencedArticles": [],
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "In Regulation (EU) No 910/2014, Article 19 is deleted with effect from 18 October 2024."
            }
          ],
          "tags": [],
          "referencedArticles": [
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "In Directive (EU) 2018/1972, Articles 40 and 41 are deleted with effect from 18 October 2024."
            }
          ],
          "tags": [],
          "referencedArticles": [],
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Each Member State shall designate or establish one or more competent authorities responsible for cybersecurity and for the supervisory tasks referred to in Chapter VII (competent authorities)."
            },
            {
              "paragraphNumber": 2,
              "text": "The competent authorities referred to in paragraph 1 shall monitor the implementation of this Directive at national level."
            },
            {
              "paragraphNumber": 3,
              "text": "Each Member State shall designate or establish a single point of contact. Where a Member State designates or establishes only one competent authority pursuant to paragraph 1, that competent authority shall also be the single point of contact for that Member State."
            },
            {
              "paragraphNumber": 4,
              "text": "Each single point of contact shall exercise a liaison function to ensure cross-border cooperation of its Member State’s authorities with the relevant authorities of other Member States, and, where appropriate, with the Commission and ENISA, as well as to ensure cross-sectoral cooperation with other competent authorities within its Member State."
            },
            {
              "paragraphNumber": 5,
              "text": "Member States shall ensure that their competent authorities and single points of contact have adequate resources to carry out, in an effective and efficient manner, the tasks assigned to them and thereby to fulfil the objectives of this Directive."
            },
            {
              "paragraphNumber": 6,
              "text": "Each Member State shall notify the Commission without undue delay of the identity of the competent authority referred to in paragraph 1 and of the single point of contact referred to in paragraph 3, of the tasks of those authorities, and of any subsequent changes thereto. Each Member State shall make public the identity of its competent authority. The Commission shall make a list of the single points of contact publicly available."
            }
          ],
          "tags": [
            "supervision_enforcement"
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Each Member State shall designate or establish one or more CSIRTs. The CSIRTs may be designated or established within a competent authority. The CSIRTs shall comply with the requirements set out in Article 11(1), shall cover at least the sectors, subsectors and types of entity referred to in Annexes I and II, and shall be responsible for incident handling in accordance with a well-defined process."
            },
            {
              "paragraphNumber": 2,
              "text": "Member States shall ensure that each CSIRT has adequate resources to carry out effectively its tasks as set out in Article 11(3)."
            },
            {
              "paragraphNumber": 3,
              "text": "Member States shall ensure that each CSIRT has at its disposal an appropriate, secure, and resilient communication and information infrastructure through which to exchange information with essential and important entities and other relevant stakeholders. To that end, Member States shall ensure that each CSIRT contributes to the deployment of secure information-sharing tools."
            },
            {
              "paragraphNumber": 4,
              "text": "The CSIRTs shall cooperate and, where appropriate, exchange relevant information in accordance with Article 29 with sectoral or cross-sectoral communities of essential and important entities."
            },
            {
              "paragraphNumber": 5,
              "text": "The CSIRTs shall participate in peer reviews organised in accordance with Article 19."
            },
            {
              "paragraphNumber": 6,
              "text": "Member States shall ensure the effective, efficient and secure cooperation of their CSIRTs in the CSIRTs network."
            },
            {
              "paragraphNumber": 7,
              "text": "The CSIRTs may establish cooperation relationships with third countries’ national computer security incident response teams. As part of such cooperation relationships, Member States shall facilitate effective, efficient and secure information exchange with those third countries’ national computer security incident response teams, using relevant information-sharing protocols, including the traffic light protocol. The CSIRTs may exchange relevant information with third countries’ national computer security incident response teams, including personal data in accordance with Union data protection law."
            },
            {
              "paragraphNumber": 8,
              "text": "The CSIRTs may cooperate with third countries’ national computer security incident response teams or equivalent third-country bodies, in particular for the purpose of providing them with cybersecurity assistance."
            },
            {
              "paragraphNumber": 9,
              "text": "Each Member State shall notify the Commission without undue delay of the identity of the CSIRT referred to in paragraph 1 of this Article and the CSIRT designated as coordinator pursuant to Article 12(1), of their respective tasks in relation to essential and important entities, and of any subsequent changes thereto."
            },
            {
              "paragraphNumber": 10,
              "text": "Member States may request the assistance of ENISA in developing their CSIRTs."
            }
          ],
          "tags": [
            "incident_reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Where they are separate, the competent authorities, the single point of contact and the CSIRTs of the same Member State shall cooperate with each other with regard to the fulfilment of the obligations laid down in this Directive."
            },
            {
              "paragraphNumber": 2,
              "text": "Member States shall ensure that their CSIRTs or, where applicable, their competent authorities, receive notifications of significant incidents pursuant to Article 23, and incidents, cyber threats and near misses pursuant to Article 30."
            },
            {
              "paragraphNumber": 3,
              "text": "Member States shall ensure that their CSIRTs or, where applicable, their competent authorities inform their single points of contact of notifications of incidents, cyber threats and near misses submitted pursuant to this Directive."
            },
            {
              "paragraphNumber": 4,
            ...
            {
              "paragraphNumber": 6,
              "text": "Member States shall simplify the reporting through technical means for notifications referred to in Articles 23 and 30."
            }
          ],
          "tags": [
            "incident_reporting",
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "EU-CyCLONe is established to support the coordinated management of large-scale cybersecurity incidents and crises at operational level and to ensure the regular exchange of relevant information among Member States and Union institutions, bodies, offices and agencies."
            },
            {
              "paragraphNumber": 2,
              "text": "EU-CyCLONe shall be composed of the representatives of Member States’ cyber crisis management authorities as well as, in cases where a potential or ongoing large-scale cybersecurity incident has or is likely to have a significant impact on services and activities falling within the scope of this Directive, the Commission. In other cases, the Commission shall participate in the activities of EU-CyCLONe as an observer.\nENISA shall provide the secretariat of EU-CyCLONe and support the secure exchange of information as well as provide necessary tools to support cooperation between Member States ensuring secure exchange of information.\nWhere appropriate, EU-CyCLONe may invite representatives of relevant stakeholders to participate in its work as observers."
            },
            {
              "paragraphNumber": 3,
              "text": "EU-CyCLONe shall have the following tasks:\n(a) to increase the level of preparedness of the management of large-scale cybersecurity incidents and crises;\n(b) to develop a shared situational awareness for large-scale cybersecurity incidents and crises;\n(c) to assess the consequences and impact of relevant large-scale cybersecurity incidents and crises and propose possible mitigation measures;\n(d) to coordinate the management of large-scale cybersecurity incidents and crises and support decision-making at political level in relation to such incidents and crises;\n(e) to discuss, upon the request of a Member State concerned, national large-scale cybersecurity incident and crisis response plans referred to in Article 9(4)."
            },
            {
              "paragraphNumber": 4,
              "text": "EU-CyCLONe shall adopt its rules of procedure."
            },
            {
              "paragraphNumber": 5,
              "text": "EU-CyCLONe shall report on a regular basis to the Cooperation Group on the management of large-scale cybersecurity incidents and crises, as well as trends, focusing in particular on their impact on essential and important entities."
            },
            {
              "paragraphNumber": 6,
              "text": "EU-CyCLONe shall cooperate with the CSIRTs network on the basis of agreed procedural arrangements provided for in Article 15(6)."
            },
            {
              "paragraphNumber": 7,
              "text": "By 17 July 2024 and every 18 months thereafter, EU-CyCLONe shall submit to the European Parliament and to the Council a report assessing its work."
            }
          ],
          "tags": [
            "incident_reporting",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "The methodology referred to in paragraph 1 shall include objective, non-discriminatory, fair and transparent criteria on the basis of which the Member States designate cybersecurity experts eligible to carry out the peer reviews. The Commission and ENISA shall participate as observers in the peer reviews."
            },
            {
              "paragraphNumber": 3,
              "text": "Member States may identify specific issues as referred to in paragraph 1, point (f), for the purposes of a peer review."
            },
            {
              "paragraphNumber": 4,
              "text": "Before commencing a peer review as referred to in paragraph 1, Member States shall notify the participating Member States of its scope, including the specific issues identified pursuant to paragraph 3."
            },
            {
              "paragraphNumber": 5,
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The Cooperation Group, in cooperation with the Commission and ENISA, may carry out coordinated security risk assessments of specific critical ICT services, ICT systems or ICT products supply chains, taking into account technical and, where relevant, non-technical risk factors."
            },
            {
              "paragraphNumber": 2,
              "text": "The Commission, after consulting the Cooperation Group and ENISA, and, where necessary, relevant stakeholders, shall identify the specific critical ICT services, ICT systems or ICT products that may be subject to the coordinated security risk assessment referred to in paragraph 1."
            }
          ],
          "tags": [
            "supply_chain",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "In order to promote the convergent implementation of Article 21(1) and (2), Member States shall, without imposing or discriminating in favour of the use of a particular type of technology, encourage the use of European and international standards and technical specifications relevant to the security of network and information systems."
            },
            {
              "paragraphNumber": 2,
              "text": "ENISA, in cooperation with Member States, and, where appropriate, after consulting relevant stakeholders, shall draw up advice and guidelines regarding the technical areas to be considered in relation to paragraph 1 as well as regarding already existing standards, including national standards, which would allow for those areas to be covered."
            }
          ],
          "tags": [],
          "referencedArticles": [
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 6,
              "text": "Compliance with the obligations laid down in paragraphs 1 to 5 shall not result in a duplication of collecting domain name registration data. To that end, Member States shall require TLD name registries and entities providing domain name registration services to cooperate with each other."
            }
          ],
          "tags": [
            "registration"
      ...
      "articles": [
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 5,
              "text": "ENISA shall provide assistance for the establishment of cybersecurity information-sharing arrangements referred to in paragraph 2 by exchanging best practices and providing guidance."
            }
          ],
          "tags": [
            "incident_reporting",
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Member States shall ensure that the administrative fines imposed on essential and important entities pursuant to this Article in respect of infringements of this Directive are effective, proportionate and dissuasive, taking into account the circumstances of each individual case."
            },
            {
              "paragraphNumber": 2,
              "text": "Administrative fines shall be imposed in addition to any of the measures referred to in Article 32(4), points (a) to (h), Article 32(5) and Article 33(4), points (a) to (g)."
            },
            {
              "paragraphNumber": 3,
              "text": "When deciding whether to impose an administrative fine and deciding on its amount in each individual case, due regard shall be given, as a minimum, to the elements provided for in Article 32(7)."
            },
            {
              "paragraphNumber": 4,
              "text": "Member States shall ensure that where they infringe Article 21 or 23, essential entities are subject, in accordance with paragraphs 2 and 3 of this Article, to administrative fines of a maximum of at least EUR 10 000 000 or of a maximum of at least 2 % of the total worldwide annual turnover in the preceding financial year of the undertaking to which the essential entity belongs, whichever is higher."
            },
            {
              "paragraphNumber": 5,
              "text": "Member States shall ensure that where they infringe Article 21 or 23, important entities are subject, in accordance with paragraphs 2 and 3 of this Article, to administrative fines of a maximum of at least EUR 7 000 000 or of a maximum of at least 1,4 % of the total worldwide annual turnover in the preceding financial year of the undertaking to which the important entity belongs, whichever is higher."
            },
            {
              "paragraphNumber": 6,
              "text": "Member States may provide for the power to impose periodic penalty payments in order to compel an essential or important entity to cease an infringement of this Directive in accordance with a prior decision of the competent authority."
            },
            {
              "paragraphNumber": 7,
              "text": "Without prejudice to the powers of the competent authorities pursuant to Articles 32 and 33, each Member State may lay down the rules on whether and to what extent administrative fines may be imposed on public administration entities."
            },
            {
              "paragraphNumber": 8,
              "text": "Where the legal system of a Member State does not provide for administrative fines, that Member State shall ensure that this Article is applied in such a manner that the fine is initiated by the competent authority and imposed by competent national courts or tribunals, while ensuring that those legal remedies are effective and have an equivalent effect to the administrative fines imposed by the competent authorities. In any event, the fines imposed shall be effective, proportionate and dissuasive. The Member State shall notify to the Commission the provisions of the laws which it adopts pursuant to this paragraph by 17 October 2024 and, without delay, any subsequent amendment law or amendment affecting them."
            }
          ],
          "tags": [
            "entity_classification",
      ...
      "articles": [
        {
          ...
          "chapterNumber": 8,
          "chapterTitle": "DELEGATED AND IMPLEMENTING ACTS",
          "paragraphs": [
            {
              "paragraphNumber": 1,
            ...
            {
              "paragraphNumber": 2,
              "text": "The power to adopt delegated acts referred to in Article 24(2) shall be conferred on the Commission for a period of five years from 16 January 2023."
            },
            {
              "paragraphNumber": 3,
              "text": "The delegation of power referred to in Article 24(2) may be revoked at any time by the European Parliament or by the Council. A decision to revoke shall put an end to the delegation of the power specified in that decision. It shall take effect the day following the publication of the decision in the Official Journal of the European Union or at a later date specified therein. It shall not affect the validity of any delegated acts already in force."
            },
            {
              "paragraphNumber": 4,
...
export const nis2AnnexesData = {
  ...
  "annexes": [
    {
      "annexNumber": "I",
      "title": "SECTORS OF HIGH CRITICALITY",
      "blocks": [
        "Sector Subsector Type of entity",
        "1. Energy",
        "(a) Electricity",
        "— Electricity undertakings as defined in Article 2, point (57), of Directive (EU) 2019/944 of the European Parliament and of the Council , which carry out the function of ‘supply’ as defined in Article 2, point (12), of that Directive",
        ...
        "(d) Road",
        "— Road authorities as defined in Article 2, point (12), of Commission Delegated Regulation (EU) 2015/962 responsible for traffic management control, excluding public entities for which traffic management or the operation of intelligent transport systems is a non-essential part of their general activity",
