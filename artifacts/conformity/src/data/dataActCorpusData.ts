/**
 * Data Act statutory corpus — Regulation (EU) 2023/2854.
 *
 * GENERATED FILE — DO NOT EDIT BY HAND.
 * Built from the Official Journal text (OJ L, 2023/2854, 22.12.2023,
 * CELEX 32023R2854) by scripts/build_consolidated_act_corpus.mjs and
 * copied here by scripts/sync_euact_corpus_data.mjs. Every recital, article
 * paragraph and annex line is verbatim OJ text.
 *
 * Regenerate:
 *   node scripts/build_consolidated_act_corpus.mjs data_act
 *   node scripts/sync_euact_corpus_data.mjs data_act
 */
export const dataActRecitalsData = {
  ...
  "corrigenda": [
    {
      ...
      "article": 48,
      "from": "‘68. Regulation (EU) 2023/2854",
      "to": "‘(69) Regulation (EU) 2023/2854",
      "note": "Art 48: the point number this Regulation takes in Annex I to Directive (EU) 2020/1828 is (69), not 68."
    }
  ],
  "builtFrom": "docs/data_act_statutory_corpus/source/CELEX_32023R2854_EN.html",
  "sourceSha256": "97143ad0e720522e1c6cbeebd0ef87f90b7c2edd9bcfe6b0fa90fd0673bc548f",
  "recitalsCount": 120,
  "chaptersCount": 11,
  "totalArticles": 50,
  "annexesCount": 0,
  "recitals": [
    ...
    },
    {
      "number": 12,
      "title": "Recital 12",
      "text": "(11) Union law establishing physical design and data requirements for products to be placed on the Union market should not be affected unless specifically provided for by this Regulation.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    {
      "number": 13,
      "title": "Recital 13",
      "text": "(12) This Regulation complements and is without prejudice to Union law aiming to establish accessibility requirements on certain products and services, in particular Directive (EU) 2019/882 of the European Parliament and of the Council .",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    {
      "number": 14,
      "title": "Recital 14",
      "text": "(13) This Regulation is without prejudice to Union and national legal acts providing for the protection of intellectual property rights, including Directives 2001/29/EC , 2004/48/EC and (EU) 2019/790 of the European Parliament and of the Council.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 30,
      "title": "Recital 30",
      "text": "(29) Data holders may require appropriate user identification to verify a user’s entitlement to access the data. In the case of personal data processed by a processor on behalf of the controller, data holders should ensure that the access request is received and handled by the processor.",
      "tags": [
        "data_holder"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 38,
      "title": "Recital 38",
      "text": "(37) In order to prevent the exploitation of users, third parties to whom data has been made available at the request of the user should process those data only for the purposes agreed with the user and share them with another third party only with the agreement of the user to such data sharing.",
      "tags": [
        "data_sharing"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 45,
      "title": "Recital 45",
      "text": "(44) In order to ensure that the conditions for mandatory data access are fair for both parties to a contract, the general rules on data access rights should refer to the rule on avoiding unfair contractual terms.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 55,
      "title": "Recital 55",
      "text": "(54) To avoid cases in which two or more dispute settlement bodies are seized for the same dispute, in particular in a cross-border situation, a dispute settlement body should be able to refuse to deal with a request to resolve a dispute that has already been brought before another dispute settlement body or before a court or tribunal of a Member State.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 68,
      "title": "Recital 68",
      "text": "(67) This Regulation complements and is without prejudice to the Union and national law providing for access to and the use of data for statistical purposes, in particular Regulation (EC) No 223/2009 of the European Parliament and of the Council as well as national legal acts related to official statistics.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    ...
    },
    {
      "number": 85,
      "title": "Recital 85",
      "text": "(84) This Regulation aims to facilitate switching between data processing services, which encompasses conditions and actions that are necessary for a customer to terminate a contract for a data processing service, to conclude one or more new contracts with different providers of data processing services, to port its exportable data and digital assets, and where applicable, benefit from functional equivalence.",
      "tags": [
        "switching"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 87,
      "title": "Recital 87",
      "text": "(86) Functional equivalence means re-establishing, on the basis of the customer’s exportable data and digital assets, a minimum level of functionality in the environment of a new data processing service of the same service type after switching, where the destination data processing service delivers a materially comparable outcome in response to the same input for shared features supplied to the customer under the contract. Providers of data processing services can only be expected to facilitate functional equivalence for the features that both the source and destination data processing services offer independently. This Regulation does not constitute an obligation to facilitate functional equivalence for providers of data processing services other than those offering services of the IaaS delivery model.",
      "tags": [
        "switching"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 92,
      "title": "Recital 92",
      "text": "(91) Where providers of data processing services are in turn customers of data processing services provided by a third-party provider, they will benefit from more effective switching themselves while simultaneously remaining bound by this Regulation’s obligations regarding their own service offerings.",
      "tags": [
        "switching"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 97,
      "title": "Recital 97",
      "text": "(96) To facilitate interoperability and switching between data processing services, users and providers of data processing services should consider the use of implementation and compliance tools, in particular those published by the Commission in the form of an EU Cloud Rulebook and a Guidance on public procurement of data processing services. In particular, standard contractual clauses are beneficial because they increase confidence in data processing services, create a more balanced relationship between users and providers of data processing services and improve legal certainty with regard to the conditions that apply for switching to other data processing services. In that context, users and providers of data processing services should consider the use of standard contractual clauses or other self-regulatory compliance tools provided that they fully comply with this Regulation, developed by relevant bodies or expert groups established under Union law.",
      "tags": [
        "switching",
        "interoperability"
      ],
    ...
    },
    {
      "number": 98,
      "title": "Recital 98",
      "text": "(97) In order to facilitate switching between data processing services, all parties involved, including both source and destination providers of data processing services, should cooperate in good faith to make the switching process effective, enable the secure and timely transfer of necessary data in a commonly used, machine-readable format, and by means of open interfaces, while avoiding service disruptions and maintaining continuity of the service.",
      "tags": [
        "switching"
      ],
      "relatedArticles": [],
    ...
    },
    {
      "number": 117,
      "title": "Recital 117",
      "text": "(116) This Regulation should not affect the application of the rules of competition, in particular Articles 101 and 102 TFEU. The measures provided for in this Regulation should not be used to restrict competition in a manner contrary to the TFEU.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    {
      "number": 118,
      "title": "Recital 118",
      "text": "(117) In order to allow actors within the scope of this Regulation to adapt to the new rules provided for herein, and to make the necessary technical arrangements, those rules should apply from 12 September 2025.",
      "tags": [],
      "relatedArticles": [],
      "relatedAnnexes": []
    },
    {
      "number": 119,
      "title": "Recital 119",
      "text": "(118) The European Data Protection Supervisor and the European Data Protection Board were consulted in accordance with Article 42(1) and (2) of Regulation (EU) 2018/1725 and delivered their opinion on 4 May 2022.",
      "tags": [],
      "relatedArticles": [
        42
      ],
...
export const dataActArticlesData = {
  "regulation": "Regulation (EU) 2023/2854",
  "shortTitle": "Data Act",
  "officialJournalReference": "OJ L, 2023/2854, 22.12.2023",
  "celex": "32023R2854",
  ...
  "chapters": [
      ...
      "articles": [
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 10,
              "text": "Where there is no agreement on the necessary measures referred to in paragraph 9 of this Article or if the third party fails to implement the measures agreed pursuant to paragraph 9 of this Article or undermines the confidentiality of the trade secrets, the data holder may withhold or, as the case may be, suspend the sharing of data identified as trade secrets. The decision of the data holder shall be duly substantiated and provided in writing to the third party without undue delay. In such cases, the data holder shall notify the competent authority designated pursuant to Article 37 that it has withheld or suspended data sharing and identify which measures have not been agreed or implemented and, where relevant, which trade secrets have had their confidentiality undermined."
            },
            {
              "paragraphNumber": 11,
            ...
            {
              "paragraphNumber": 12,
              "text": "Without prejudice to the third party’s right to seek redress at any stage before a court or tribunal of a Member State, a third party wishing to challenge a data holder’s decision to refuse or to withhold or suspend data sharing pursuant to paragraphs 10 and 11 may:\n(a) lodge, in accordance with Article 37(5), point (b), a complaint with the competent authority, which shall, without undue delay, decide whether and under which conditions the data sharing is to start or resume; or\n(b) agree with the data holder to refer the matter to a dispute settlement body in accordance with Article 10(1)."
            },
            {
              "paragraphNumber": 13,
              "text": "The right referred to in paragraph 1 shall not adversely affect the rights of data subjects pursuant to the applicable Union and national law on the protection of personal data."
            }
          ],
          "tags": [
            "connected_products",
      ...
      "articles": [
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 3,
              "text": "A data holder shall not discriminate regarding the arrangements for making data available between comparable categories of data recipients, including partner enterprises or linked enterprises of the data holder when making data available. Where a data recipient considers that the conditions under which data has been made available to it are discriminatory, the data holder shall without undue delay provide the data recipient, upon its reasoned request, with information showing that there has been no discrimination."
            },
            {
              "paragraphNumber": 4,
              "text": "A data holder shall not make data available to a data recipient, including on an exclusive basis, unless requested to do so by the user under Chapter II."
            },
            {
              "paragraphNumber": 5,
              "text": "Data holders and data recipients shall not be required to provide any information beyond what is necessary to verify compliance with the contractual terms agreed for making data available or with their obligations under this Regulation or other applicable Union law or national legislation adopted in accordance with Union law."
            },
            {
              "paragraphNumber": 6,
              "text": "Unless otherwise provided for in Union law, including Article 4(6) and Article 5(9) of this Regulation, or by national legislation adopted in accordance with Union law, an obligation to make data available to a data recipient shall not oblige the disclosure of trade secrets."
            }
          ],
          "tags": [
            "data_holder",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Any compensation agreed upon between a data holder and a data recipient for making data available in business-to-business relations shall be non- discriminatory and reasonable and may include a margin."
            },
            {
              "paragraphNumber": 2,
              "text": "When agreeing on any compensation, the data holder and the data recipient shall take into account in particular:\n(a) costs incurred in making the data available, including, in particular, the costs necessary for the formatting of data, dissemination via electronic means and storage;\n(b) investments in the collection and production of data, where applicable, taking into account whether other parties contributed to obtaining, generating or collecting the data in question."
            },
            {
              "paragraphNumber": 3,
              "text": "The compensation referred to in paragraph 1 may also depend on the volume, format and nature of the data."
            },
            {
              "paragraphNumber": 4,
              "text": "Where the data recipient is an SME or a not-for-profit research organisation and where such a data recipient does not have partner enterprises or linked enterprises that do not qualify as SMEs, any compensation agreed shall not exceed the costs referred to in paragraph 2, point (a)."
            },
            {
              "paragraphNumber": 5,
              "text": "The Commission shall adopt guidelines on the calculation of reasonable compensation, taking into account the advice of the European Data Innovation Board (EDIB) referred to in Article 42."
            },
            {
              "paragraphNumber": 6,
              "text": "This Article shall not preclude other Union law or national legislation adopted in accordance with Union law from excluding compensation for making data available or providing for lower compensation."
            },
            {
              "paragraphNumber": 7,
              "text": "The data holder shall provide the data recipient with information setting out the basis for the calculation of the compensation in sufficient detail so that the data recipient can assess whether the requirements of paragraphs 1 to 4 are met."
            }
          ],
          "tags": [
            "data_holder"
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Users, data holders and data recipients shall have access to a dispute settlement body, certified in accordance with paragraph 5 of this Article, to settle disputes pursuant to Article 4(3) and (9) and Article 5(12) as well as disputes relating to the fair, reasonable and non-discriminatory terms and conditions for, and transparent manner of, making data available in accordance with this Chapter and Chapter IV."
            },
            {
              "paragraphNumber": 2,
              "text": "Dispute settlement bodies shall make the fees, or the mechanisms used to determine the fees, known to the parties concerned before those parties request a decision."
            },
            {
              "paragraphNumber": 3,
              "text": "For disputes referred to a dispute settlement body pursuant to Article 4(3) and (9) and Article 5(12), where the dispute settlement body decides a dispute in favour of the user or of the data recipient, the data holder shall bear all the fees charged by the dispute settlement body and shall reimburse that user or that data recipient for any other reasonable expenses that it has incurred in relation to the dispute settlement. If the dispute settlement body decides a dispute in favour of the data holder, the user or the data recipient shall not be required to reimburse any fees or other expenses that the data holder paid or is to pay in relation to the dispute settlement, unless the dispute settlement body finds that the user or the data recipient manifestly acted in bad faith."
            },
            {
              "paragraphNumber": 4,
              "text": "Customers and providers of data processing services shall have access to a dispute settlement body, certified in accordance with paragraph 5 of this Article, to settle disputes relating to breaches of the rights of customers and the obligations of providers of data processing services, in accordance with Articles 23 to 31."
            },
            {
              "paragraphNumber": 5,
              "text": "The Member State where the dispute settlement body is established shall, at the request of that body, certify that body where it has demonstrated that it meets all of the following conditions:\n(a) it is impartial and independent, and it is to issue its decisions in accordance with clear, non-discriminatory and fair rules of procedure;\n(b) it has the necessary expertise, in particular in relation to fair, reasonable and non-discriminatory terms and conditions, including compensation, and on making data available in a transparent manner, allowing the body to effectively determine those terms and conditions;\n(c) it is easily accessible through electronic communication technology;\n(d) it is capable of adopting its decisions in a swift, efficient and cost-effective manner in at least one official language of the Union."
            },
            {
              "paragraphNumber": 6,
              "text": "Member States shall notify to the Commission the dispute settlement bodies certified in accordance with paragraph 5. The Commission shall publish a list of those bodies on a dedicated website and keep it updated."
            },
            {
              "paragraphNumber": 7,
              "text": "A dispute settlement body shall refuse to deal with a request to resolve a dispute that has already been brought before another dispute settlement body or before a court or tribunal of a Member State."
            },
            {
              "paragraphNumber": 8,
              "text": "A dispute settlement body shall grant parties the possibility, within a reasonable period of time, to express their points of view on the matters those parties have brought before that body. In that context, each party to a dispute shall be provided with the submissions of the other party to their dispute and any statements made by experts. The parties shall be given the possibility to comment on those submissions and statements."
            },
            {
              "paragraphNumber": 9,
              "text": "A dispute settlement body shall adopt its decision on a matter referred to it within 90 days of receipt of a request pursuant to paragraphs 1 and 4. That decision shall be in writing or on a durable medium and shall be supported by a statement of reasons."
            },
            {
              "paragraphNumber": 10,
              "text": "Dispute settlement bodies shall draw up and make publicly available annual activity reports. Such annual reports shall include, in particular, the following general information:\n(a) an aggregation of the outcomes of disputes;\n(b) the average time taken to resolve disputes;\n(c) the most common reasons for disputes."
            },
            {
              "paragraphNumber": 11,
              "text": "In order to facilitate the exchange of information and best practices, a dispute settlement body may decide to include recommendations in the report referred to in paragraph 10 as to how problems can be avoided or resolved."
            },
            {
              "paragraphNumber": 12,
              "text": "The decision of a dispute settlement body shall be binding on the parties only if the parties have explicitly consented to its binding nature prior to the start of the dispute settlement proceedings."
            },
            {
              "paragraphNumber": 13,
              "text": "This Article does not affect the right of parties to seek an effective remedy before a court or tribunal of a Member State."
            }
          ],
          "tags": [
            "data_holder"
        ...
        {
          "articleNumber": 12,
          "title": "Scope of obligations for data holders obliged pursuant to Union law to make data available",
          "chapterNumber": 3,
          "chapterTitle": "OBLIGATIONS FOR DATA HOLDERS OBLIGED TO MAKE DATA AVAILABLE PURSUANT TO UNION LAW",
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "This Chapter shall apply where, in business-to-business relations, a data holder is obliged under Article 5 or under applicable Union law or national legislation adopted in accordance with Union law, to make data available to a data recipient."
            },
            {
              "paragraphNumber": 2,
              "text": "A contractual term in a data sharing agreement which, to the detriment of one party, or, where applicable, to the detriment of the user, excludes the application of this Chapter, derogates from it, or varies its effect, shall not be binding on that party."
            }
          ],
          "tags": [
            "data_holder",
      ...
      "articles": [
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 7,
              "text": "Where the unfair contractual term is severable from the remaining terms of the contract, those remaining terms shall be binding."
            },
            {
              "paragraphNumber": 8,
              "text": "This Article does not apply to contractual terms defining the main subject matter of the contract or to the adequacy of the price, as against the data supplied in exchange."
            },
            {
              "paragraphNumber": 9,
              "text": "The parties to a contract covered by paragraph 1 shall not exclude the application of this Article, derogate from it, or vary its effects."
            }
          ],
          "tags": [
            "trade_secrets"
    ...
    },
    {
      ...
      "articles": [
        ...
        {
          "articleNumber": 16,
          "title": "Relationship with other obligations to make data available to public sector bodies, the Commission, the European Central Bank and Union bodies",
          "chapterNumber": 5,
          "chapterTitle": "MAKING DATA AVAILABLE TO PUBLIC SECTOR BODIES, THE COMMISSION, THE EUROPEAN CENTRAL BANK AND UNION BODIES ON THE BASIS OF AN EXCEPTIONAL NEED",
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "This Chapter shall not affect the obligations laid down in Union or national law for the purposes of reporting, complying with requests for access to information or demonstrating or verifying compliance with legal obligations."
            },
            {
              "paragraphNumber": 2,
              "text": "This Chapter shall not apply to public sector bodies, the Commission, the European Central Bank or Union bodies carrying out activities for the prevention, investigation, detection or prosecution of criminal or administrative offences or the execution of criminal penalties, or to customs or taxation administration. This Chapter does not affect applicable Union and national law on the prevention, investigation, detection or prosecution of criminal or administrative offences or the execution of criminal or administrative penalties, or for customs or taxation administration."
            }
          ],
          "tags": [
            "b2g"
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "A data holder receiving a request to make data available under this Chapter shall make the data available to the requesting public sector body, the Commission, the European Central Bank or a Union body without undue delay, taking into account necessary technical, organisational and legal measures."
            },
            {
              "paragraphNumber": 2,
              "text": "Without prejudice to specific needs regarding the availability of data defined in Union or national law, a data holder may decline or seek the modification of a request to make data available under this Chapter without undue delay and, in any event, no later than five working days after the receipt of a request for the data necessary to respond to a public emergency and without undue delay and, in any event, no later than 30 working days after the receipt of such a request in other cases of an exceptional need, on any of the following grounds:\n(a) the data holder does not have control over the data requested;\n(b) a similar request for the same purpose has been previously submitted by another public sector body or the Commission, the European Central Bank or a Union body and the data holder has not been notified of the erasure of the data pursuant to Article 19(1), point (c);\n(c) the request does not meet the conditions laid down in Article 17(1) and (2)."
            },
            {
              "paragraphNumber": 3,
              "text": "If the data holder decides to decline the request or to seek its modification in accordance with paragraph 2, point (b), it shall indicate the identity of the public sector body or the Commission, the European Central Bank or the Union body that previously submitted a request for the same purpose."
            },
            {
              "paragraphNumber": 4,
        ...
        {
          "articleNumber": 22,
          "title": "Mutual assistance and cross-border cooperation",
          "chapterNumber": 5,
          "chapterTitle": "MAKING DATA AVAILABLE TO PUBLIC SECTOR BODIES, THE COMMISSION, THE EUROPEAN CENTRAL BANK AND UNION BODIES ON THE BASIS OF AN EXCEPTIONAL NEED",
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Public sector bodies, the Commission, the European Central Bank and Union bodies shall cooperate and assist one another, to implement this Chapter in a consistent manner."
            },
            {
              "paragraphNumber": 2,
              "text": "Any data exchanged in the context of assistance requested and provided pursuant to paragraph 1 shall not be used in a manner incompatible with the purpose for which they were requested."
            },
            {
              "paragraphNumber": 3,
              "text": "Where a public sector body intends to request data from a data holder established in another Member State, it shall first notify the competent authority designated pursuant to Article 37 in that Member State of that intention. This requirement shall also apply to requests by the Commission, the European Central Bank and Union bodies. The request shall be examined by the competent authority of the Member State where the data holder is established."
            },
            {
              "paragraphNumber": 4,
              "text": "After having examined the request in light of the requirements laid down in Article 17, the relevant competent authority shall, without undue delay, take one of the following actions:\n(a) transmit the request to the data holder and, if applicable, advise the requesting public sector body, the Commission, the European Central Bank or the Union body of the need, if any, to cooperate with public sector bodies of the Member State in which the data holder is established with the aim of reducing the administrative burden on the data holder in complying with the request;\n(b) reject the request on duly substantiated grounds in accordance with this Chapter.\nThe requesting public sector body, the Commission, the European Central Bank and the Union body shall take into account the advice of and the grounds provided by the relevant competent authority pursuant to the first subparagraph before taking any further action such as resubmitting the request, if applicable."
            }
          ],
          "tags": [
            "data_holder",
    ...
    },
    {
      ...
      "articles": [
        ...
        {
          "articleNumber": 24,
          "title": "Scope of the technical obligations",
          "chapterNumber": 6,
          "chapterTitle": "SWITCHING BETWEEN DATA PROCESSING SERVICES",
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "The responsibilities of providers of data processing services laid down in Articles 23, 25, 29, 30 and 34 shall apply only to the services, contracts or commercial practices provided by the source provider of data processing services."
            }
          ],
          "tags": [],
          "referencedArticles": [],
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "All parties involved, including destination providers of data processing services, shall cooperate in good faith to make the switching process effective, enable the timely transfer of data and maintain the continuity of the data processing service."
            }
          ],
          "tags": [
            "switching"
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "From 12 January 2027, providers of data processing services shall not impose any switching charges on the customer for the switching process."
            },
            {
              "paragraphNumber": 2,
              "text": "From 11 January 2024 to 12 January 2027, providers of data processing services may impose reduced switching charges on the customer for the switching process."
            },
            {
              "paragraphNumber": 3,
              "text": "The reduced switching charges referred to in paragraph 2 shall not exceed the costs incurred by the provider of data processing services that are directly linked to the switching process concerned."
            },
            {
              "paragraphNumber": 4,
            ...
            {
              "paragraphNumber": 5,
              "text": "Where relevant, providers of data processing services shall provide information to a customer on data processing services that involve highly complex or costly switching or for which it is impossible to switch without significant interference in the data, digital assets or service architecture."
            },
            {
              "paragraphNumber": 6,
              "text": "Where applicable, providers of data processing services shall make the information referred to in paragraphs 4 and 5 publicly available to customers via a dedicated section of their website or in any other easily accessible way."
            },
            {
              "paragraphNumber": 7,
              "text": "The Commission is empowered to adopt delegated acts in accordance with Article 45 to supplement this Regulation by establishing a monitoring mechanism for the Commission to monitor switching charges, imposed by providers of data processing services on the market to ensure that the withdrawal and reduction of switching charges, pursuant to paragraphs 1 and 2 of this Article are to be attained in accordance with the deadlines laid down in those paragraphs."
            }
          ],
          "tags": [
            "switching"
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 4,
              "text": "Providers of data processing services other than those referred to in paragraph 1 of this Article shall update the online register referred to in Article 26, point (b) in accordance with their obligations under paragraph 3 of this Article."
            },
            {
              "paragraphNumber": 5,
              "text": "In the case of switching between services of the same service type, for which common specifications or the harmonised standards for interoperability referred to in paragraph 3 of this Article have not been published in the central Union standards repository for the interoperability of data processing services in accordance with Article 35(8), the provider of data processing services shall, at the request of the customer, export all exportable data in a structured, commonly used and machine-readable format."
            },
            {
              "paragraphNumber": 6,
              "text": "Providers of data processing services shall not be required to develop new technologies or services, or disclose or transfer digital assets that are protected by intellectual property rights or that constitute a trade secret, to a customer or to a different provider of data processing services or compromise the customer’s or provider’s security and integrity of service."
            }
          ],
          "tags": [
            "switching",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The obligations laid down in Article 23, point (d), Article 29 and Article 30(1) and (3) shall not apply to data processing services of which the majority of main features has been custom-built to accommodate the specific needs of an individual customer or where all components have been developed for the purposes of an individual customer, and where those data processing services are not offered at broad commercial scale via the service catalogue of the provider of data processing services."
            },
            {
              "paragraphNumber": 2,
              "text": "The obligations laid down in this Chapter shall not apply to data processing services provided as a non-production version for testing and evaluation purposes and for a limited period of time."
            },
            {
              "paragraphNumber": 3,
              "text": "Prior to the conclusion of a contract on the provision of the data processing services referred to in this Article, the provider of data processing services shall inform the prospective customer of the obligations of this Chapter that do not apply."
            }
          ],
          "tags": [],
          "referencedArticles": [
    ...
    },
    {
      "chapterNumber": 7,
      "label": "CHAPTER VII",
      "title": "UNLAWFUL INTERNATIONAL GOVERNMENTAL ACCESS AND TRANSFER OF NON-PERSONAL DATA",
      "articles": [
        {
          "articleNumber": 32,
          "title": "International governmental access and transfer",
          "chapterNumber": 7,
          "chapterTitle": "UNLAWFUL INTERNATIONAL GOVERNMENTAL ACCESS AND TRANSFER OF NON-PERSONAL DATA",
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Providers of data processing services shall take all adequate technical, organisational and legal measures, including contracts, in order to prevent international and third-country governmental access and transfer of non-personal data held in the Union where such transfer or access would create a conflict with Union law or with the national law of the relevant Member State, without prejudice to paragraph 2 or 3."
            },
            {
              "paragraphNumber": 2,
      ...
      "articles": [
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 10,
              "text": "When a Member State considers that a common specification does not entirely satisfy the essential requirements laid down in paragraph 1, it shall inform the Commission thereof by submitting a detailed explanation. The Commission shall assess that detailed explanation and may, if appropriate, amend the implementing act establishing the common specification in question."
            },
            {
              "paragraphNumber": 11,
              "text": "The Commission may adopt guidelines taking into account the proposal of the EDIB in accordance with Article 30, point (h), of Regulation (EU) 2022/868 laying down interoperable frameworks for common standards and practices for the functioning of common European data spaces."
            }
          ],
          "tags": [
            "connected_products",
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The requirements laid down in Article 23, Article 24, Article 25(2), points (a)(ii), (a)(iv), (e) and (f) and Article 30(2) to (5) shall also apply mutatis mutandis to providers of data processing services to facilitate interoperability for the purposes of in-parallel use of data processing services."
            },
            {
              "paragraphNumber": 2,
              "text": "Where a data processing service is being used in parallel with another data processing service, the providers of data processing services may impose data egress charges, but only for the purpose of passing on egress costs incurred, without exceeding such costs."
            }
          ],
          "tags": [
            "interoperability"
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 7,
              "text": "When a Member State considers that a common specification does not entirely satisfy the essential requirements laid down in paragraphs 1 and 2, it shall inform the Commission thereof by submitting a detailed explanation. The Commission shall assess that detailed explanation and may, if appropriate, amend the implementing act establishing the common specification in question."
            },
            {
              "paragraphNumber": 8,
              "text": "For the purpose of Article 30(3), the Commission shall, by means of implementing acts, publish the references of harmonised standards and common specifications for the interoperability of data processing services in a central Union standards repository for the interoperability of data processing services."
            },
            {
              "paragraphNumber": 9,
              "text": "The implementing acts referred to in this Article shall be adopted in accordance with the examination procedure referred to in Article 46(2)."
            }
          ],
          "tags": [
            "switching",
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 7,
              "text": "Before preparing a draft implementing act referred to in paragraph 6 of this Article, the Commission shall inform the committee referred to in Article 22 of Regulation (EU) No 1025/2012 that it considers that the conditions in paragraph 6 of this Article have been fulfilled."
            },
            {
              "paragraphNumber": 8,
              "text": "When preparing the draft implementing act referred to in paragraph 6, the Commission shall take into account the advice of the EDIB and views of other relevant bodies or expert groups and shall duly consult all relevant stakeholders."
            },
            {
              "paragraphNumber": 9,
    ...
    },
    {
      ...
      "articles": [
        {
          "articleNumber": 37,
          "title": "Competent authorities and data coordinators",
          "chapterNumber": 9,
          "chapterTitle": "IMPLEMENTATION AND ENFORCEMENT",
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Each Member State shall designate one or more competent authorities to be responsible for the application and enforcement of this Regulation (competent authorities). Member States may establish one or more new authorities or rely on existing authorities."
            },
            {
              "paragraphNumber": 2,
              "text": "Where a Member State designates more than one competent authority, it shall designate a data coordinator from among them to facilitate cooperation between the competent authorities and to assist entities within the scope of this Regulation on all matters related to its application and enforcement. Competent authorities shall, in the exercise of the tasks and powers assigned to them under paragraph 5, cooperate with each other."
            },
            {
              "paragraphNumber": 3,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Without prejudice to any other administrative or judicial remedy, natural and legal persons shall have the right to lodge a complaint, individually or, where relevant, collectively, with the relevant competent authority in the Member State of their habitual residence, place of work or establishment if they consider that their rights under this Regulation have been infringed. The data coordinator shall, upon request, provide all the necessary information to natural and legal persons for the lodging of their complaints with the appropriate competent authority."
            },
            {
              "paragraphNumber": 2,
              "text": "The competent authority with which the complaint has been lodged shall inform the complainant, in accordance with national law, of the progress of the proceedings and of the decision taken."
            },
            {
              "paragraphNumber": 3,
              "text": "Competent authorities shall cooperate to handle and resolve complaints effectively and in a timely manner, including by exchanging all relevant information by electronic means, without undue delay. This cooperation shall not affect the cooperation mechanisms provided for by Chapters VI and VII of Regulation (EU) 2016/679 and by Regulation (EU) 2017/2394."
            }
          ],
          "tags": [],
          "referencedArticles": [],
        ...
        {
          "articleNumber": 39,
          "title": "Right to an effective judicial remedy",
          "chapterNumber": 9,
          "chapterTitle": "IMPLEMENTATION AND ENFORCEMENT",
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Notwithstanding any administrative or other non-judicial remedy, any affected natural and legal person shall have the right to an effective judicial remedy with regard to legally binding decisions taken by competent authorities."
            },
            {
              "paragraphNumber": 2,
              "text": "Where a competent authority fails to act on a complaint, any affected natural and legal person shall, in accordance with national law, either have the right to an effective judicial remedy or access to review by an impartial body with the appropriate expertise."
            },
            {
              "paragraphNumber": 3,
              "text": "Proceedings pursuant to this Article shall be brought before the courts or tribunals of the Member State of the competent authority against which the judicial remedy is sought individually or, where relevant, collectively by the representatives of one or more natural or legal persons."
            }
          ],
          "tags": [],
          "referencedArticles": [],
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "Member States shall lay down the rules on penalties applicable to infringements of this Regulation and shall take all measures necessary to ensure that they are implemented. The penalties provided for shall be effective, proportionate and dissuasive."
            },
            {
              "paragraphNumber": 2,
              "text": "Member States shall by 12 September 2025 notify the Commission of those rules and measures and shall notify it without delay of any subsequent amendment affecting them. The Commission shall regularly update and maintain an easily accessible public register of those measures."
            },
            {
              "paragraphNumber": 3,
              "text": "Member States shall take into account the recommendations of the EDIB and the following non-exhaustive criteria for the imposition of penalties for infringements of this Regulation:\n(a) the nature, gravity, scale and duration of the infringement;\n(b) any action taken by the infringing party to mitigate or remedy the damage caused by the infringement;\n(c) any previous infringements by the infringing party;\n(d) the financial benefits gained or losses avoided by the infringing party due to the infringement, insofar as such benefits or losses can be reliably established;\n(e) any other aggravating or mitigating factor applicable to the circumstances of the case;\n(f) infringing party’s annual turnover in the preceding financial year in the Union."
            },
            {
              "paragraphNumber": 4,
    ...
    },
    {
      "chapterNumber": 10,
      "label": "CHAPTER X",
      "title": "SUI GENERIS RIGHT UNDER DIRECTIVE 96/9/EC",
      "articles": [
        {
          "articleNumber": 43,
          "title": "Databases containing certain data",
          "chapterNumber": 10,
          "chapterTitle": "SUI GENERIS RIGHT UNDER DIRECTIVE 96/9/EC",
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "The sui generis right provided for in Article 7 of Directive 96/9/EC shall not apply when data is obtained from or generated by a connected product or related service falling within the scope of this Regulation, in particular in relation to Articles 4 and 5 thereof."
            }
          ],
          "tags": [
            "connected_products"
    ...
    },
    {
      ...
      "articles": [
        {
          "articleNumber": 44,
          "title": "Other Union legal acts governing rights and obligations on data access and use",
          "chapterNumber": 11,
          "chapterTitle": "FINAL PROVISIONS",
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The specific obligations for the making available of data between businesses, between businesses and consumers, and on exceptional basis between businesses and public bodies, in Union legal acts that entered into force on or before 11 January 2024, and delegated or implementing acts pursuant thereto, shall remain unaffected."
            },
            {
              "paragraphNumber": 2,
              "text": "This Regulation is without prejudice to Union law specifying, in light of the needs of a sector, a common European data space, or an area of public interest, further requirements, in particular in relation to:\n(a) technical aspects of data access;\n(b) limits on the rights of data holders to access or use certain data provided by users;\n(c) aspects going beyond data access and use."
            },
            {
              "paragraphNumber": 3,
              "text": "This Regulation, with the exception of Chapter V, is without prejudice to Union and national law providing for access to and authorising the use of data for scientific research purposes."
            }
          ],
          "tags": [
            "data_holder"
        ...
        },
        {
          ...
          "paragraphs": [
            ...
            {
              "paragraphNumber": 2,
              "text": "The power to adopt delegated acts referred to in Article 29(7) and Article 33(2) shall be conferred on the Commission for an indeterminate period of time from 11 January 2024."
            },
            {
              "paragraphNumber": 3,
              "text": "The delegation of power referred to in Article 29(7) and Article 33(2) may be revoked at any time by the European Parliament or by the Council. A decision to revoke shall put an end to the delegation of the power specified in that decision. It shall take effect the day following the publication of the decision in the Official Journal of the European Union or at a later date specified therein. It shall not affect the validity of any delegated acts already in force."
            },
            {
              "paragraphNumber": 4,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 1,
              "text": "The Commission shall be assisted by the Committee established by Regulation (EU) 2022/868. That committee shall be a committee within the meaning of Regulation (EU) No 182/2011."
            },
            {
              "paragraphNumber": 2,
        ...
        },
        {
          ...
          "paragraphs": [
            {
              "paragraphNumber": 0,
              "text": "In Annex I to Directive (EU) 2020/1828 the following point is added:\n‘(69) Regulation (EU) 2023/2854 of the European Parliament and of the Council of 13 December 2023 on harmonised rules on fair access to and use of data and amending Regulation (EU) 2017/2394 and Directive (EU) 2020/1828 (Data Act) ( OJ L, 2023/2854, 22.12.2023, ELI: http://data.europa.eu/eli/reg/2023/2854/oj ). ’"
            }
          ],
          "tags": [],
          "referencedArticles": [],
...
export const dataActAnnexesData = {
  "regulation": "Regulation (EU) 2023/2854",
  "shortTitle": "Data Act",
  "officialJournalReference": "OJ L, 2023/2854, 22.12.2023",
  "celex": "32023R2854",
