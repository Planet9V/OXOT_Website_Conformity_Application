...
export const recitalsData = {
  ...
  "corrigendaNoted": [
    ...
    {
      "id": "32024R2847R(03)",
      "note": "FR, HU only — the English text is not affected."
    },
    {
      "id": "32024R2847R(05)",
      "note": "SK only."
  ...
  "annexes": [
    ...
    },
    {
      ...
      "blocks": [
        ...
        "3. Quality system",
        "3.1. The manufacturer shall lodge an application for assessment of its quality system with the notified body of its choice, for the products with digital elements concerned. The application shall include:",
