...
const copy = {
  en: {
    nav: {
      ...
      integrators: 'For integrators & partners', suppliers: 'For component & IP suppliers',
      craTransit: 'CRA in transit',
    ...
    navDesc: {
      ...
      suppliers: 'Answer your customers’ due diligence with one package',
  ...
  nl: {
    nav: {
      ...
      integrators: 'Voor integrators & partners', suppliers: 'Voor component- & IP-leveranciers',
      craTransit: 'CRA in transit',
    ...
    navDesc: {
      ...
      suppliers: 'Beantwoord de due diligence van uw klanten met één pakket',
