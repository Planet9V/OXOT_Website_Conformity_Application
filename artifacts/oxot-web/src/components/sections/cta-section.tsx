  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-display font-bold tracking-tight text-background mb-6 max-w-3xl mx-auto leading-tight">
          {data.title}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          {data.primaryCta && (
            <Button asChild size="lg" className="w-full sm:w-auto h-14 px-8 rounded-full text-base bg-primary text-primary-foreground hover:bg-primary/90">
