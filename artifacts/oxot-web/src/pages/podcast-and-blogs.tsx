...
export default function PodcastAndBlogsPage() {
  ...
  const episodes: Episode[] = useMemo(() => [
    ...
    { id: 'EP_8.01', code: 'EP_8.01', title: 'The €15M Calculation: Demystifying Article 64 Turnover Fines', category: 'standard', statutes: ['Article 64', 'Recital 78'], persona: 'CEOs, CFOs & General Counsel', duration: '14:40', audioUrl: 'https://oxot.ai/audio/cra_podcast/EP_8.01.mp3', blogSlug: 'the-15000000-calculation-demystifying-article-61-administrat', summary: 'How European market surveillance calculates the 2.5% global turnover fine and officer liability.' },
